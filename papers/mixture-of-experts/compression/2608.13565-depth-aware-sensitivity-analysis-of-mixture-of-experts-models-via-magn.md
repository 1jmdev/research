...
**arXiv:** [2608.13565](https://arxiv.org/abs/2608.13565) · [PDF](https://arxiv.org/pdf/2608.13565) · [HTML](https://arxiv.org/html/2608.13565) · **First submitted:** 2026-06-25  
**Category:** [MoE compression (expert pruning, merging, quantization)](README.md) — **rank #70 of 76** by impact score  

> **TL;DR** — A systematic layer-wise sensitivity analysis of the Qwen3.6-35B-A3B model using magnitude-based expert masking on the XLCoST cross-lingual code translation benchmark provides an empirical foundation for depth-aware MoE expert masking and establishes a practical path toward physical weight surgery, activation-based expert scoring, and training-based recovery.
...
- Flat all-layer masking at 30% retains only 150/300 Good+Similar outputs at 300-prompt scale, whereas late-focused policies retain 249-255/300 while masking 640-1,145 experts.
...
```sh
arxiv read 2608.13565            # full paper as Markdown (github.com/1jmdev/arxiv)
arxiv section 2608.13565 "method"
arxiv bibtex 2608.13565
```
