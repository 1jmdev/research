...
**arXiv:** [2608.12146](https://arxiv.org/abs/2608.12146) · [PDF](https://arxiv.org/pdf/2608.12146) · [HTML](https://arxiv.org/html/2608.12146) · **First submitted:** 2026-08-12  
**Category:** [MoE training systems](README.md) — **rank #58 of 61** by impact score  
**Also relevant to:** [MoE architecture & routing](../architecture-and-routing/README.md)  

> **TL;DR** — This work presents RoutePack, a hierarchical planner that coordinates state-consistent, layer-wise expert rerouting with joint attention- and expert-aware data packing over an optimizer-step window and improves throughput by 8.85% and 14.89% over the baseline.
...
- Across Ling-3.0-Tiny and Ling-3.0-Flash, expert rerouting improves mean trainer-measured token throughput by 3.80% and 10.50%, while routing-aware packing adds another 4.86% and 3.98%, respectively.
- Overall, RoutePack improves throughput by 8.85% and 14.89% over the baseline.
...
```sh
arxiv read 2608.12146            # full paper as Markdown (github.com/1jmdev/arxiv)
arxiv section 2608.12146 "method"
arxiv bibtex 2608.12146
```
