...
**arXiv:** [2508.01261](https://arxiv.org/abs/2508.01261) · [PDF](https://arxiv.org/pdf/2508.01261) · [HTML](https://arxiv.org/html/2508.01261) · **First submitted:** 2025-08-02  
**Category:** [MoE architecture & routing](README.md) — **rank #76 of 115** by impact score  
...
> **TL;DR** — The results establish that architectural novelty, not parameter scaling, defines the efficiency frontier for resource-constrained language model deployment.
...
- Extensive experiments on models ranging from 17M to 202M parameters demonstrate that MoE-MLA-RoPE with compression ratio r=d/2 achieves 68% KV cache memory reduction and 3.2x inference speedup while maintaining competitive perplexity (0.8% degradation).
- Compared to the parameters with 53.9M parameters, MoE-MLA-RoPE improves the validation loss by 6.9% over the vanilla transformers while using 42% fewer active parameters per forward pass.
- FLOP-matched experiments reveal even larger gains: 11.1% improvement with 3.2x inference acceleration.
...
```sh
arxiv read 2508.01261            # full paper as Markdown (github.com/1jmdev/arxiv)
arxiv section 2508.01261 "method"
arxiv bibtex 2508.01261
```
