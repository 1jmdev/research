...
**arXiv:** [2609.21346](https://arxiv.org/abs/2609.21346) · [PDF](https://arxiv.org/pdf/2609.21346) · [HTML](https://arxiv.org/html/2609.21346) · **First submitted:** 2026-09-18  
**Category:** [MoE architecture & routing](README.md) — **rank #14 of 115** by impact score  

> **TL;DR** — IntBMoE is a block-conditioned MoE that decouples all three by pairing dense expert composition with sparse block execution, and shows consistent gains over representative sparse and dense MoE baselines on image classification.
...
- IntBMoE is fully deployed in AMap's generative recommendation system, serving hundreds of millions of users under a 60ms latency budget, with a 2.4% relative UVCTR gain in online A/B testing.
...
```sh
arxiv read 2609.21346            # full paper as Markdown (github.com/1jmdev/arxiv)
arxiv section 2609.21346 "method"
arxiv bibtex 2609.21346
```
