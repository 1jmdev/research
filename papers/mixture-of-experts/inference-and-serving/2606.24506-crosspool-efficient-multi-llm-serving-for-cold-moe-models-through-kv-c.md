...
**arXiv:** [2606.24506](https://arxiv.org/abs/2606.24506) · [PDF](https://arxiv.org/pdf/2606.24506) · [HTML](https://arxiv.org/html/2606.24506) · **First submitted:** 2026-06-26  
**Category:** [MoE inference & serving (expert offloading, EP)](README.md) — **rank #71 of 168** by impact score  
**Also relevant to:** [Prefill/decode disaggregation & phase-aware serving](../../serving-systems/disaggregated-prefill-decode/README.md) · [MoE architecture & routing](../architecture-and-routing/README.md) · [Memory management & offloading (weights, activations)](../../serving-systems/memory-and-offloading/README.md) · [Request scheduling, batching & SLO serving](../../serving-systems/scheduling-and-batching/README.md) · [KV cache — general, systems & analysis](../../kv-cache/_general/README.md)  

> **TL;DR** — CrossPool is presented, a serving engine for cold MoE models that separates FFN weights and KV-cache into two GPU memory pools: a weights pool that consolidates FFN weights across cold models, and a KV-cache pool that dynamically serves active requests while keeping attention local to KV-cache.
...
- With efficient GPU memory pooling, CrossPool underpins bursty long-context requests and outperforms the state-of-the-art kvcached-based multi-LLM serving system, reducing P99 TBT by up to 10.4x.
...
```sh
arxiv read 2606.24506            # full paper as Markdown (github.com/1jmdev/arxiv)
arxiv section 2606.24506 "method"
arxiv bibtex 2606.24506
```
