...
**Category:** [Novel architectures & architecture analysis](README.md) — **rank #68 of 135** by impact score  

> **TL;DR** — The Dual-Stream Transformer is introduced, which decomposes the residual stream into two functionally distinct components: a token stream updated by attention and a context stream updated by feed-forward networks that provide a foundation for interpretable language models where internal structure is exposed by design.
