...
**Category:** [Novel architectures & architecture analysis](README.md) — **rank #66 of 135** by impact score  

> **TL;DR** — SymbolicLight V1, a spike-gated dual-path language model that couples binary Leaky Integrate-and-Fire dynamics with a continuous residual stream, is presented and an entropy-modulated rule reverses that ranking.
