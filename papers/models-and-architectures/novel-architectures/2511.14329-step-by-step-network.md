...
**Category:** [Novel architectures & architecture analysis](README.md) — **rank #84 of 135** by impact score  

> **TL;DR** — A generalized residual architecture dubbed Step by Step Network (StepsNet) is proposed to bridge the gap between theoretical potential and practical performance of deep models, and is positioned as a superior generalization of the widely adopted residual architecture.
