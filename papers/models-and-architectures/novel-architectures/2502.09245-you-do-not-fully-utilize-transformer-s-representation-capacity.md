...
**Category:** [Novel architectures & architecture analysis](README.md) — **rank #14 of 111** by impact score  

> **TL;DR** — Layer-Integrated Memory (LIMe) addresses representation collapse in Transformers by allowing access to hidden states from earlier layers, leading to consistent performance improvements across tasks.
