...
**Category:** [Novel architectures & architecture analysis](README.md) — **rank #132 of 134** by impact score  

> **TL;DR** — The resulting claim is deliberately narrow: direct product FFNs can improve fixed-budget small-model loss in specific low-compute regimes, but the branch is optimization-sensitive and does not establish FLOP-normalized efficiency, scaling behavior, or broad LLM performance.
