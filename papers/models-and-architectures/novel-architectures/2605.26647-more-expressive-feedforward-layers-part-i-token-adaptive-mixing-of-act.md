...
**arXiv:** [2605.26647](https://arxiv.org/abs/2605.26647) · [PDF](https://arxiv.org/pdf/2605.26647) · [HTML](https://arxiv.org/html/2605.26647) · **First submitted:** 2026-08-28  
**Category:** [Novel architectures & architecture analysis](README.md) — **rank #24 of 111** by impact score  

> **TL;DR** — This work proposes Mixture of Activations (MoA), a token-adaptive FFN design that mixes a dictionary of activation functions using lightweight input-dependent gates while sharing the same linear projections, suggesting that token-adaptive activation mixing is a simple and effective mechanism for improving FFN expressivity in LLMs.
...
```sh
arxiv read 2605.26647            # full paper as Markdown (github.com/1jmdev/arxiv)
arxiv section 2605.26647 "method"
arxiv bibtex 2605.26647
```
