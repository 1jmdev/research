...
**Category:** [Novel architectures & architecture analysis](README.md) — **rank #101 of 134** by impact score  

> **TL;DR** — It is found that massive activations exist only because one stream is forced to be both scratchpad and answer, then a dedicated answer channel should remove the need for them, and it is found that it does not.
