...
**Category:** [Novel architectures & architecture analysis](README.md) — **rank #103 of 134** by impact score  

> **TL;DR** — This work introduces a novel approach to integrates the output projection and loss prediction into a single operation, by directly computing the loss from hidden states and target tokens, which reduces memory usage and alleviates bandwidth pressure.
