...
**Category:** [Novel architectures & architecture analysis](README.md) — **rank #106 of 135** by impact score  

> **TL;DR** — This work explores a fourth dimension, virtual logical depth (VLD), which increases effective algorithmic depth without changing parameter count by reusing weights, suggesting a new scaling path beyond token-wise test-time methods.
