...
**Category:** [Model technical reports (open & frontier models)](README.md) — **rank #142 of 164** by impact score  

> **TL;DR** — This work introduces PARAM-1, a 2.9B parameter decoder-only, text-only language model trained from scratch with an explicit architectural and linguistic focus on Indian diversity, and demonstrates that it serves as both a competent general-purpose model and a robust baseline for India-centric applications.
