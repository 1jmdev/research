...
**arXiv:** [2607.20062](https://arxiv.org/abs/2607.20062) · [PDF](https://arxiv.org/pdf/2607.20062) · [HTML](https://arxiv.org/html/2607.20062) · **First submitted:** 2026-07-24  
**Category:** [Model technical reports (open & frontier models)](README.md) — **rank #161 of 164** by impact score  
**Also relevant to:** [Hybrid architectures (attention + SSM/linear layers)](../../attention/hybrid-architectures/README.md)  

> **TL;DR** — This work presents Solar Open 2, a 250B-A15B Mixture-of-Experts language model built for long-horizon agentic tasks, scaled up from Solar Open 1, which records the highest average of any model compared, including fast-tier closed APIs, and stays competitive with the strongest models elsewhere.

## At a glance

| Field | Value |
| --- | --- |
| Authors | Sungrae Park, Sanghoon Kim, Gyoungjin Gim, Jungho Cho, Hyunwoong Ko, Minbyul Jeong, Minjeong Kim, Keunwoo Choi, Chaehun Shin, Chanwoong Yoon, … (+43) |
...
- For the data, we curate for value per token: quality- and rarity-aware data curation and mixture-ratio optimization refine a 20T pool into a 10T mixture that, at equal token budget, outperforms the Solar Open 1 recipe.
...
```sh
arxiv read 2607.20062            # full paper as Markdown (github.com/1jmdev/arxiv)
arxiv section 2607.20062 "method"
arxiv bibtex 2607.20062
```
