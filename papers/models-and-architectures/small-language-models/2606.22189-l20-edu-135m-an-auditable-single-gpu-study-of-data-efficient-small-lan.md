...
**Category:** [Small language models (≤ ~4B)](README.md) — **rank #36 of 42** by impact score  
**Also relevant to:** [Reinforcement learning for LLM reasoning (GRPO, RLVR)](../../training/rl-for-reasoning/README.md)  

> **TL;DR** — A sharply resource-constrained regime: a complete 134.5M-parameter language-model pipeline executed on one NVIDIA L20 GPU that exceeds several older 100M-160M public baselines under the same harness and identifies a concrete failure mode on RLVR on GSM8K.
