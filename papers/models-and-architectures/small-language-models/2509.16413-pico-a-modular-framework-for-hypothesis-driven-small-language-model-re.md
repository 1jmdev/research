...
**Category:** [Small language models (≤ ~4B)](README.md) — **rank #25 of 42** by impact score  

> **TL;DR** — Pico, a lightweight, modular framework that enables systematic, hypothesis-driven research for small and medium-scale language model development, is introduced and a suite of baseline models, pico-decoder, trained under standardized conditions and open-sourced for the community are released.
