...
**Category:** [Small language models (≤ ~4B)](README.md) — **rank #14 of 41** by impact score  

> **TL;DR** — Small language models experience significant performance declines when trained on long chain-of-thought data due to error accumulation, impacting downstream reinforcement learning but potentially mitigated by extensive supervised fine-tuning.
