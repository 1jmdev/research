...
**Category:** [Prompt & context compression](README.md) — **rank #72 of 112** by impact score  

> **TL;DR** — Efficient and Flexible Prompt Compression (EFPC), a novel method unifying task-aware and task-agnostic compression for a favorable accuracy-efficiency trade-off, is proposed, offering a practical advancement in NLP.
