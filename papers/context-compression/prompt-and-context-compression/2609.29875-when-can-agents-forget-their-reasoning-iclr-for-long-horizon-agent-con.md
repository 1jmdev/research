...
**arXiv:** [2609.29875](https://arxiv.org/abs/2609.29875) · [PDF](https://arxiv.org/pdf/2609.29875) · [HTML](https://arxiv.org/html/2609.29875) · **First submitted:** 2026-09-24  
**Category:** [Prompt & context compression](README.md) — **rank #111 of 112** by impact score  

> **TL;DR** — Results characterize agent reasoning as dynamic working state rather than permanent interaction history, and suggest that historical reasoning becomes more replaceable once task relevant derived state has been reliably externalized into code, files, tool outputs, or environmental feedback.
...
- On 260 WorkBuddyBench tasks, ICLR improves average reward from 0.699 to 0.718, while reducing input, output, and cache read tokens by 25.5%, 14.4%, and 33.3%, respectively.
...
```sh
arxiv read 2609.29875            # full paper as Markdown (github.com/1jmdev/arxiv)
arxiv section 2609.29875 "method"
arxiv bibtex 2609.29875
```
