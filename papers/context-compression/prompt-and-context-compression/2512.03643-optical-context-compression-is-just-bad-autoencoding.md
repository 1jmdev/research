...
**Category:** [Prompt & context compression](README.md) — **rank #70 of 112** by impact score  

> **TL;DR** — Comparing DeepSeek-OCR's vision encoder against near-zero-parameter mean pooling and a learned hierarchical encoder, it is found it does not achieve the best direct baseline, and all compression methods outperform truncation for factual recall, but vision never surpasses the best direct baseline.
