...
**Category:** [Prompt & context compression](README.md) — **rank #63 of 112** by impact score  

> **TL;DR** — This work proposes a hybrid adapter to refine global semantics with the global view, based on the observation that different adapters excel at different tasks, and introduces auxiliary paraphrasing and completion pretraining before instruction tuning to foster a balanced integration of global and local compression.
