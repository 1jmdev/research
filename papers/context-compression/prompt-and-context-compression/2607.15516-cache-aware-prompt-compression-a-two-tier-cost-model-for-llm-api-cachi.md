...
**arXiv:** [2607.15516](https://arxiv.org/abs/2607.15516) · [PDF](https://arxiv.org/pdf/2607.15516) · [HTML](https://arxiv.org/html/2607.15516) · **First submitted:** 2026-07-17  
**Category:** [Prompt & context compression](README.md) — **rank #73 of 112** by impact score  

> **TL;DR** — This work proposes Cache-Aware Prompt Compression (CAPC), pairing query-agnostic compression with explicit cache_control plus a tier-preserving ratio bound that prevents over-compression from pushing the cached prefix into the hot tier.
...
```sh
arxiv read 2607.15516            # full paper as Markdown (github.com/1jmdev/arxiv)
arxiv section 2607.15516 "method"
arxiv bibtex 2607.15516
```
