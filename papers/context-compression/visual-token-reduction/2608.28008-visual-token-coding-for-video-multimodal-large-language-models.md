...
**Category:** [Visual token pruning / merging for VLMs](README.md) — **rank #243 of 308** by impact score  
...
> **TL;DR** — A new token compression paradigm for video Multimodal Large Language Models (MLLMs), termed Visual Token Coding (VTC), which performs structured compression by predicting the I/P frames of a video and measuring their frame-wise residuals to estimate token redundancy.
