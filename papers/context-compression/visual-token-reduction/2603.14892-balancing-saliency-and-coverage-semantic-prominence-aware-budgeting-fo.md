...
**Category:** [Visual token pruning / merging for VLMs](README.md) — **rank #264 of 308** by impact score  

> **TL;DR** — PromPrune is proposed, a sample-adaptive visual token selection framework composed of semantic prominence-aware budget allocation and a two-stage selection pipeline that adaptively balances local saliency preservation and global coverage according to the semantic prominence distribution of each sample.
