...
**Category:** [Visual token pruning / merging for VLMs](README.md) — **rank #169 of 308** by impact score  

> **TL;DR** — This work proposes a self-adaptive cross-modality attention mixture mechanism that dynamically leverages the effectiveness of visual saliency and text-to-image similarity in the pre-LLM layers to select the visual tokens that are informative.
