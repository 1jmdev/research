...
**Category:** [Visual token pruning / merging for VLMs](README.md) — **rank #21 of 308** by impact score  

> **TL;DR** — A thorough study on token similarity characteristics reveals three key insights, revealing that spatially corresponding visual tokens between adjacent frames have higher cosine similarities compared to other token pairs; and high token similarities prominently decrease in deeper model layers; and token similarity rankings are highly consistent across different layers.
