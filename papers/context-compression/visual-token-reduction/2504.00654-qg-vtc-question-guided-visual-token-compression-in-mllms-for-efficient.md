...
**Category:** [Visual token pruning / merging for VLMs](README.md) — **rank #206 of 308** by impact score  

> **TL;DR** — QG-VTC is proposed, a novel question-guided visual token compression method for MLLM-based VQA tasks that maximizes retention of question-relevant information while discarding irrelevant details.
