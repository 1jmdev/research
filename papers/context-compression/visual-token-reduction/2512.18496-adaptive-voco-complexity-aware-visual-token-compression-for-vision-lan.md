...
**Category:** [Visual token pruning / merging for VLMs](README.md) — **rank #254 of 308** by impact score  

> **TL;DR** — Adaptive-VoCo is proposed, a framework that augments VoCo-LLaMA with a lightweight predictor for adaptive compression, which introduces a joint loss function that integrates rate regularization with complexity alignment and consistently outperforms fixed-rate baselines across multiple multimodal tasks.
