...
**Category:** [Visual token pruning / merging for VLMs](README.md) — **rank #183 of 308** by impact score  

> **TL;DR** — DynaTok is presented, a training-free, temporally adaptive and bias-aware token compression framework that allocates token budgets across both temporal and spatial dimensions, and retains over 95% of baseline accuracy even with a 90% token reduction.
