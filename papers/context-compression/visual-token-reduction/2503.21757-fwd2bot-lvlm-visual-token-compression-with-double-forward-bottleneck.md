...
**Category:** [Visual token pruning / merging for VLMs](README.md) — **rank #248 of 308** by impact score  

> **TL;DR** — This work proposes a novel compression approach, called Fwd2Bot, that uses the LVLM itself to compress the visual information in a task-agnostic manner and results in highly-informative compressed representations suitable for both generative and discriminative tasks.
