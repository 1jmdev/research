...
**Category:** [Visual token pruning / merging for VLMs](README.md) — **rank #274 of 308** by impact score  

> **TL;DR** — Across fine-grained short-video and long-video reasoning benchmarks, Fre-Res achieves a favorable accuracy--efficiency trade-off, matching or approaching full-token performance while substantially reducing visual-token length.
