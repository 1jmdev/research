...
**Category:** [Visual token pruning / merging for VLMs](README.md) — **rank #69 of 308** by impact score  

> **TL;DR** — This work introduces intra-ViT early compression, which reduces tokens in shallow ViT layers and substantially lowers visual-encoding FLOPs while preserving downstream performance, suggesting that visual-encoding efficiency can be substantially improved without sacrificing downstream performance.
