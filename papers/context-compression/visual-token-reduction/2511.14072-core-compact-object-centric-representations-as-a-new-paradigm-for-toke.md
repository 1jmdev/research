...
**Category:** [Visual token pruning / merging for VLMs](README.md) — **rank #257 of 308** by impact score  

> **TL;DR** — CORE (Compact Object-centric REpresentations), a new paradigm for visual token compression that establishes a new state-of-the-art on six authoritative benchmarks for fixed-rate compression, but also achieves dramatic efficiency gains in adaptive-rate settings.
