...
**Category:** [Visual token pruning / merging for VLMs](README.md) — **rank #166 of 308** by impact score  
...
> **TL;DR** — COAST (COntrastive Adaptive Semantic Token Pruning), a training-free pruning framework that casts compression as adaptive semantic routing, is introduced, showing that adaptive semantic routing is a robust alternative to one-shot scalar pruning.
