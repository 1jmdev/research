...
**arXiv:** [2609.16722](https://arxiv.org/abs/2609.16722) · [PDF](https://arxiv.org/pdf/2609.16722) · [HTML](https://arxiv.org/html/2609.16722) · **First submitted:** 2026-09-15  
**Category:** [Visual token pruning / merging for VLMs](README.md) — **rank #220 of 301** by impact score  

> **TL;DR** — VideoMM is introduced, which marks a paradigm shift from model-centric downsizing to adaptive perceptual granularity and accelerates inference by 2.73 times over current leading methods, establishing a highly scalable paradigm for long-video understanding.
...
| arXiv categories | cs.AI, cs.CL, cs.CV, cs.MM |
...
- It achieves a 6.13$\times$ speedup and a 7.4\% accuracy gain over full-context baselines on LongVideoBench, and further accelerates inference by 2.73$\times$ over current leading methods, establishing a highly scalable paradigm for long-video understanding.
...
```sh
arxiv read 2609.16722            # full paper as Markdown (github.com/1jmdev/arxiv)
arxiv section 2609.16722 "method"
arxiv bibtex 2609.16722
```
