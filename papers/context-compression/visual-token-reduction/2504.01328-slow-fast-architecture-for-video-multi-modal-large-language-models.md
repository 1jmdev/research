...
**Category:** [Visual token pruning / merging for VLMs](README.md) — **rank #83 of 301** by impact score  

> **TL;DR** — A slow-fast architecture using dual-token strategy enables efficient and high-performing video-based multi-modal large language models by balancing temporal resolution and spatial detail.
