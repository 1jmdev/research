...
**Category:** [Visual token pruning / merging for VLMs](README.md) — **rank #184 of 308** by impact score  

> **TL;DR** — Fourier Compressor is introduced, an effective, parameter-free, and highly generalizable module that removes redundancy from visual representations within the frequency domain and consistently outperforms existing parameter-free methods and even surpasses some parameterized approaches.
