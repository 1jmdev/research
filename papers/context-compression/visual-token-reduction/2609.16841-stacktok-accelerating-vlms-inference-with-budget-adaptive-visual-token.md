...
**Category:** [Visual token pruning / merging for VLMs](README.md) — **rank #305 of 308** by impact score  
...
> **TL;DR** — StackTok is introduced, a training-free selector that treats query relevance as the objective and visual coverage as budget-calibrated support in vision-language models and ranks first among training-free selectors in every tested model--budget setting.
