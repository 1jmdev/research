...
**Category:** [Visual token pruning / merging for VLMs](README.md) — **rank #198 of 308** by impact score  

> **TL;DR** — LLaVA-UHD v3 is presented, an MLLM centered upon the proposed Progressive Visual Compression (PVC) method, which can be seamlessly integrated into standard Vision Transformer (ViT) to enable efficient native-resolution encoding.
