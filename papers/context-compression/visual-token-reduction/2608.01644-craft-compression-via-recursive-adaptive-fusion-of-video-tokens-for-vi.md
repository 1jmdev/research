...
**Category:** [Visual token pruning / merging for VLMs](README.md) — **rank #292 of 308** by impact score  
**Also relevant to:** [Model compression — general & surveys](../../compression/_general/README.md)  

> **TL;DR** — Experiments on multiple representative video benchmarks show that CRAFT consistently outperforms prior state-of-the-art token-compression methods and shows significant efficiency improvement.
