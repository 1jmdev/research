...
**arXiv:** [2503.20540](https://arxiv.org/abs/2503.20540) · [PDF](https://arxiv.org/pdf/2503.20540) · [HTML](https://arxiv.org/html/2503.20540) · **First submitted:** 2025-03-26  
**Category:** [Visual token pruning / merging for VLMs](README.md) — **rank #159 of 308** by impact score  

> **TL;DR** — This work manipulates the visual input and investigates variations in the textual output from both token-centric and context-centric perspectives and introduces a context-independent condition to identify redundant prototypes from training images, which probes the redundancy of each visual token during inference.
...
```sh
arxiv read 2503.20540            # full paper as Markdown (github.com/1jmdev/arxiv)
arxiv section 2503.20540 "method"
arxiv bibtex 2503.20540
```
