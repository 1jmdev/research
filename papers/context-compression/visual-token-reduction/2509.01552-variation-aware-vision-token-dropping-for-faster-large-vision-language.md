...
**Category:** [Visual token pruning / merging for VLMs](README.md) — **rank #50 of 308** by impact score  
**Also relevant to:** [KV cache eviction / token selection / sparse retrieval](../../kv-cache/eviction-and-token-selection/README.md)  

> **TL;DR** — Variation-aware Vision Token Dropping is proposed, which progressively removes visual tokens with minimal variation during LVLM inference, thereby enhancing computational efficiency and identifying critical limitations in existing inner-LLM token compression methods.
