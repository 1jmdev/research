...
**Category:** [Visual token pruning / merging for VLMs](README.md) — **rank #197 of 308** by impact score  

> **TL;DR** — This paper proposes QuickMerge, a lightweight token merging framework designed for efficient next-token prediction that reduces token counts sustantially while matching as well as exceeding the performance of learned tokenizers and fixed-patch baselines.
