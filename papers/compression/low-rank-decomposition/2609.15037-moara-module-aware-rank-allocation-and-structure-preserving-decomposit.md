...
**Category:** [Low-rank decomposition & weight factorization](README.md) — **rank #53 of 82** by impact score  

> **TL;DR** — This work proposes MoARa, which combines a static profiling-based module-aware projection-rank allocation with a block-wise magnitude-direction decomposition; the default block size is set in the neighborhood of the attention head dimension.
