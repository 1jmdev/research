...
**Category:** [Low-rank decomposition & weight factorization](README.md) — **rank #44 of 82** by impact score  
**Also relevant to:** [Hardware accelerators (ASIC, FPGA, PIM, NPU, photonic)](../../serving-systems/hardware-accelerators/README.md)  

> **TL;DR** — A tensor-train decomposition (TTD) for LLMs with a further hardware implementation on FPGA with results showing that the corresponding TTD based LLM accelerator implemented on FPGA achieves 1.45$\times$ and 1.57$\times$ reduction in first token delay for ChatGLM3-6B and LLaMA2-7B models, respectively.
