...
**Category:** [Low-rank decomposition & weight factorization](README.md) — **rank #55 of 82** by impact score  

> **TL;DR** — SALAAD is proposed, a plug-and-play framework applicable to different model architectures that induces sparse and low-rank structures during training that substantially reduces memory consumption during deployment while achieving performance comparable to ad-hoc methods.
