...
**arXiv:** [2607.05339](https://arxiv.org/abs/2607.05339) · [PDF](https://arxiv.org/pdf/2607.05339) · [HTML](https://arxiv.org/html/2607.05339) · **First submitted:** 2026-07-06  
**Category:** [Knowledge distillation (LLM → smaller LLM)](README.md) — **rank #128 of 247** by impact score  
**Also relevant to:** [Reinforcement learning for LLM reasoning (GRPO, RLVR)](../../training/rl-for-reasoning/README.md)  

> **TL;DR** — TREK (Teacher-Routed Exploration via Forward KL), a simple staged procedure that uses distillation not for imitation but for exploration support expansion, achieves high success rates early in training while unaided GRPO requires substantially more optimization steps to reach comparable levels.

## At a glance

| Field | Value |
| --- | --- |
| Authors | Yuanda Xu, Zhengze Zhou, Kayhan Behdin, Jelena Markovic-Voronov, Hejian Sang, Xiaomin Li, Wenhui Zhu, Xinchen Du, Aida Rahmattalabi, Ran He, … (+3) |
| arXiv categories | cs.LG, cs.AI, stat.ML |
| arXiv comments | 18 pages, 3 figures, 6 tables |
...
**Keywords:** Group Relative Policy Optimization, distillation, exploration support expansion, forward KL, teacher-routed exploration, verified output trajectories, on-policy support, mathematical reasoning, agentic tasks, ALFWorld, ScienceWorld

## Reproduce / read

```sh
arxiv read 2607.05339            # full paper as Markdown (github.com/1jmdev/arxiv)
arxiv section 2607.05339 "method"
arxiv bibtex 2607.05339
```
