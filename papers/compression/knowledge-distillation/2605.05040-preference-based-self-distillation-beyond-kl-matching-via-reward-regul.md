...
> **TL;DR** — PBSD is proposed, which revisits on-policy self-distillation through a reward-regularized perspective, and derives a reward-regularized objective whose analytic optimum is a reward-reweighted teacher distribution, yielding a target policy provably superior to the original teacher under this objective.
