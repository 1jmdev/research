...
**Category:** [Knowledge distillation (LLM → smaller LLM)](README.md) — **rank #247 of 247** by impact score  
**Also relevant to:** [Reinforcement learning for LLM reasoning (GRPO, RLVR)](../../training/rl-for-reasoning/README.md)  

> **TL;DR** — UECR-GRPO is introduced, which integrates verifier and teacher signals within a single GRPO-style update at both the response and token levels and uses the signed teacher--old-policy token gap to redistribute the verifier-derived component.
