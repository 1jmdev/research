...
**arXiv:** [2607.22583](https://arxiv.org/abs/2607.22583) · [PDF](https://arxiv.org/pdf/2607.22583) · [HTML](https://arxiv.org/html/2607.22583) · **First submitted:** 2026-08-02  
**Category:** [Structured pruning (layers, heads, width, experts)](README.md) — **rank #140 of 149** by impact score  
**Also relevant to:** [Edge, mobile & on-device inference](../../serving-systems/edge-and-on-device/README.md) · [Serving & inference systems — general](../../serving-systems/_general/README.md)  

> **TL;DR** — The proposed approach achieves better performance on commonsense reasoning tasks than existing methods while significantly reducing inference cost, and achieves a favorable trade-off among accuracy, latency, and model size, making it suitable for edge deployment.
...
| arXiv comments | Submitted to the ICTAI 2026 (under review) |
...
```sh
arxiv read 2607.22583            # full paper as Markdown (github.com/1jmdev/arxiv)
arxiv section 2607.22583 "method"
arxiv bibtex 2607.22583
```
