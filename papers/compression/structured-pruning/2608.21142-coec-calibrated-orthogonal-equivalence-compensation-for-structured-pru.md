...
**arXiv:** [2608.21142](https://arxiv.org/abs/2608.21142) · [PDF](https://arxiv.org/pdf/2608.21142) · [HTML](https://arxiv.org/html/2608.21142) · **First submitted:** 2026-08-21  
**Category:** [Structured pruning (layers, heads, width, experts)](README.md) — **rank #143 of 149** by impact score  

> **TL;DR** — COEC (Calibrated Orthogonal-Equivalence Compensation), a training-free compensation framework that applies alternating left and right orthogonal rotations to the retained weight, improves perplexity on every model and zero-shot accuracy in most settings over existing compensation methods.
...
| Models used | Llama-3, Llama-3.1, Qwen2.5 |
| Impact score | 0.0 |

## Key results (claimed in abstract)

- Experiments on the Llama-3, Llama-3.1, and Qwen2.5 model families across multiple structured sparsity levels show that COEC improves perplexity on every model and zero-shot accuracy in most settings over existing compensation methods, with larger gains at higher sparsity.
...
```sh
arxiv read 2608.21142            # full paper as Markdown (github.com/1jmdev/arxiv)
arxiv section 2608.21142 "method"
arxiv bibtex 2608.21142
```
