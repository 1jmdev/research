...
> **TL;DR** — Kairos is an SLO-aware scheduling system equipped with two complementary mechanisms that maximizes throughput while strictly adhering to SLO requirements and introduces slack-guided adaptive batching on the decode side.
