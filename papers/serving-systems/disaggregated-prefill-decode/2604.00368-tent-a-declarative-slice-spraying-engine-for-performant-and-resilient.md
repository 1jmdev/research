...
**Category:** [Prefill/decode disaggregation & phase-aware serving](README.md) — **rank #45 of 76** by impact score  
**Also relevant to:** [Request scheduling, batching & SLO serving](../scheduling-and-batching/README.md)  

> **TL;DR** — TENT is presented, a declarative orchestration engine that decouples transfer intent from physical execution and enables transparent, sub-50 ms self-healing by rerouting slices around failures or degradations without application-level intervention.
