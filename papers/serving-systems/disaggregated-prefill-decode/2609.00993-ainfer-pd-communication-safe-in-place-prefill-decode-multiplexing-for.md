...
**arXiv:** [2609.00993](https://arxiv.org/abs/2609.00993) · [PDF](https://arxiv.org/pdf/2609.00993) · [HTML](https://arxiv.org/html/2609.00993) · **First submitted:** 2026-09-15  
**Category:** [Prefill/decode disaggregation & phase-aware serving](README.md) — **rank #71 of 76** by impact score  

> **TL;DR** — AInfer-PD coordinates P/D collective order across ranks and gives the two DeepEP paths independent communication state, making crossed ADP/ATP and DeepEP paths safe for concurrent P/D execution.

## At a glance

| Field | Value |
| --- | --- |
| Authors | Guowei Wang, Chaokun Yang, Zhenxuan Pan, Yipeng Wei, Yuhong Guo, Minghua Zhu, Zhechuan Zhang, Shuo Wan, Xiaowei Zhu |
...
- Across repeated single-node prefill-intensive workloads, AInfer-PD reduces fixed-workload rollout completion time by 7.1-22.5% relative to the same AInfer engine with P/D multiplexing disabled and by 24.8-32.9% relative to SGLang.
- On two nodes, the reductions are 18.0-35.3% and 18.3-31.8%, respectively.
- In a same-engine ablation, fine-grained boundaries reduce completion time by a further 8.6-19.8% over whole-epoch asynchronous enqueue.
...
```sh
arxiv read 2609.00993            # full paper as Markdown (github.com/1jmdev/arxiv)
arxiv section 2609.00993 "method"
arxiv bibtex 2609.00993
```
