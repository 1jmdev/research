...
**arXiv:** [2607.28150](https://arxiv.org/abs/2607.28150) · [PDF](https://arxiv.org/pdf/2607.28150) · [HTML](https://arxiv.org/html/2607.28150) · **First submitted:** 2026-07-30  
...
> **TL;DR** — SmartGen is designed, a KV cache transfer engine that allows seamless disaggregated LLM inference with three data transfer paths that reduces time-to-second-token by up to 4.3x compared with the typical full KV cache transfer approach while offering comparable subsequent decoding performance and accuracy.
...
- Experimental results show that SmartGen reduces time-to-second-token by up to 4.3x compared with the typical full KV cache transfer approach while offering comparable subsequent decoding performance and accuracy.
...
```sh
arxiv read 2607.28150            # full paper as Markdown (github.com/1jmdev/arxiv)
arxiv section 2607.28150 "method"
arxiv bibtex 2607.28150
```
