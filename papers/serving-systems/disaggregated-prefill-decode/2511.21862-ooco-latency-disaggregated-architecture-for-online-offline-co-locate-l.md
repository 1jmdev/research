...
> **TL;DR** — A latency-constraint disaggregated architecture is proposed, which separates cluster resources into latency-strict and latency-relaxed pools based on task latency requirements, and enables flexible placement of offline decode tasks, mitigating P/D imbalance while preserving online performance.
