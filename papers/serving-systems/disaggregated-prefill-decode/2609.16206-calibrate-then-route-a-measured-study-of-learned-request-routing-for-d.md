...
**arXiv:** [2609.16206](https://arxiv.org/abs/2609.16206) · [PDF](https://arxiv.org/pdf/2609.16206) · [HTML](https://arxiv.org/html/2609.16206) · **First submitted:** 2026-09-14  
**Category:** [Prefill/decode disaggregation & phase-aware serving](README.md) — **rank #75 of 76** by impact score  
**Also relevant to:** [Request scheduling, batching & SLO serving](../scheduling-and-batching/README.md) · [MoE architecture & routing](../../mixture-of-experts/architecture-and-routing/README.md) · [KV cache — general, systems & analysis](../../kv-cache/_general/README.md)  

> **TL;DR** — A router is studied that estimates the additional completion time on each instance using exact prompt length, predicted output length, post admission KV cache pressure, and SLO class to match the goodput of round robin using six GPUs instead of seven.
...
- Hardware calibration matters: simulator derived constants cost 4.5 goodput points and roughly 40 percent of the tail latency advantage, reducing the scorer to little more than queue counting.
...
```sh
arxiv read 2609.16206            # full paper as Markdown (github.com/1jmdev/arxiv)
arxiv section 2609.16206 "method"
arxiv bibtex 2609.16206
```
