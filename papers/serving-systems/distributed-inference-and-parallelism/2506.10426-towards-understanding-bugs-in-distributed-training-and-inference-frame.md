...
**Category:** [Distributed inference & parallelism (TP/PP/SP/CP/EP)](README.md) — **rank #50 of 180** by impact score  

> **TL;DR** — This paper conducts the first large-scale empirical analysis of 308 fixed bugs across three popular distributed training/inference frameworks: DeepSpeed, Megatron-LM, and Colossal-AI and observes that 48% of bug fixes require minimal code changes and follow simple strategies such as conditional logic optimization, parameter handling enhancement, or version compatibility handling, indicating potential for automation.
