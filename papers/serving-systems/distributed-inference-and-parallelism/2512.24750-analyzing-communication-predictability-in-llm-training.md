...
> **TL;DR** — This work develops an analytical formulation to estimate communication overhead in LLM training, which is validated with high accuracy against empirical data and proposes a configuration tuning tool, ConfigTuner, to optimize training performance.
