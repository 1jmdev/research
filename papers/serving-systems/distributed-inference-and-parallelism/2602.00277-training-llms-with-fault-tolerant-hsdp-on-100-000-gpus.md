...
> **TL;DR** — Fault Tolerant Hybrid-Shared Data Parallelism (FT-HSDP) can reduce the stall time due to failure recovery from 10 minutes to 3 minutes, increasing effective training time from 44\% to 80\%.
