...
> **TL;DR** — Speculative reduction is proposed, which initiates data transfer before the top barrier and ensures correctness via lightweight validation during low-latency inference, which reduces synchronization overhead during low-latency inference.
