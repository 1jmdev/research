...
> **TL;DR** — Nitsum is presented, a distributed LLM serving system that treats tensor parallelism (TP) as a first-class runtime control surface rather than a static deployment choice and jointly optimizes TP level, prefill/decode GPU split, and request scheduling.
