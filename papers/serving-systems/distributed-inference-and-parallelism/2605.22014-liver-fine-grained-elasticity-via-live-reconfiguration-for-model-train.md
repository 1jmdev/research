...
**arXiv:** [2605.22014](https://arxiv.org/abs/2605.22014) · [PDF](https://arxiv.org/pdf/2605.22014) · [HTML](https://arxiv.org/html/2605.22014) · **First submitted:** 2026-05-21  
**Category:** [Distributed inference & parallelism (TP/PP/SP/CP/EP)](README.md) — **rank #146 of 180** by impact score  

> **TL;DR** — This work presents LiveR, a live reconfiguration runtime for elastic LLM training that replaces storage-backed restart with a live, bounded-memory handoff between mixed-parallel training worlds, and implements LiveR atop Megatron-LM and PyTorch and evaluates it end-to-end on a multi-node GPU cluster.
...
```sh
arxiv read 2605.22014            # full paper as Markdown (github.com/1jmdev/arxiv)
arxiv section 2605.22014 "method"
arxiv bibtex 2605.22014
```
