...
**arXiv:** [2608.22503](https://arxiv.org/abs/2608.22503) · [PDF](https://arxiv.org/pdf/2608.22503) · [HTML](https://arxiv.org/html/2608.22503) · **First submitted:** 2026-08-23  
**Category:** [Distributed inference & parallelism (TP/PP/SP/CP/EP)](README.md) — **rank #169 of 180** by impact score  

> **TL;DR** — Folding this model into an augmented Hockney communication cost model, it is shown that the synchronization tax fundamentally limits the return on bandwidth scaling and inverts prevailing beliefs about how interconnect bandwidth should scale with domain size.
...
- We call this waiting time the synchronization tax and show that it can consume over 50% of collective communication time in an 8-GPU scale-up domain.
- To understand the sources of this tax, we design a graph-based algorithm that operates on per-rank kernel traces, revealing that cross-rank variation in GEMM kernel execution times accounts for 78% of this overhead.
...
```sh
arxiv read 2608.22503            # full paper as Markdown (github.com/1jmdev/arxiv)
arxiv section 2608.22503 "method"
arxiv bibtex 2608.22503
```
