...
**Category:** [Distributed inference & parallelism (TP/PP/SP/CP/EP)](README.md) — **rank #5 of 180** by impact score  
...
> **TL;DR** — TokenWeave is presented, the first system to enable efficient compute-communication overlap for tensor-parallel model inference for token lengths as small as 1024 and delivers better performance than an equivalent model with all communication removed.
