...
> **TL;DR** — Galvatron is presented, a novel open-source framework that dynamically combines data parallelism, tensor model parallelism, and pipeline parallelism to optimize training throughput and is situate in context with related efforts, highlighting how it advances the state of the art in distributed deep learning.
