...
**Category:** [Distributed inference & parallelism (TP/PP/SP/CP/EP)](README.md) — **rank #29 of 180** by impact score  

> **TL;DR** — OctoPipe is proposed, a pipeline parallelism system to jointly optimize partitioning, placement, and scheduling and implement a unified pipeline executor that dynamically orchestrates computation and communication to support irregular execution orders without deadlocks while maximizing communication-computation overlap.
