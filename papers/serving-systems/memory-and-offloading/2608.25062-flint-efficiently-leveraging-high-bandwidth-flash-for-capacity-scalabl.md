...
**Category:** [Memory management & offloading (weights, activations)](README.md) — **rank #15 of 39** by impact score  
**Also relevant to:** [Serving & inference systems — general](../_general/README.md)  

> **TL;DR** — FLINT is proposed, a workload-driven HBF substrate for capacity-scalable LLM inference that integrates HBF as a memory-capacity tier alongside HBM while addressing three adoption challenges.
