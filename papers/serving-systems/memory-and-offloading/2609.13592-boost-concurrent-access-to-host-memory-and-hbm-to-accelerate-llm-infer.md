...
**arXiv:** [2609.13592](https://arxiv.org/abs/2609.13592) · [PDF](https://arxiv.org/pdf/2609.13592) · [HTML](https://arxiv.org/html/2609.13592) · **First submitted:** 2026-09-11  
**Category:** [Memory management & offloading (weights, activations)](README.md) — **rank #37 of 39** by impact score  
...
> **TL;DR** — The key insight in BOOST is to use kernel access patterns to make page allocation and runtime data management wave-aware, and applies modulo-based page placement that eliminates access-ratio variance.
...
| arXiv comments | 15 pages, 22 Figures |
...
- At iso-batch size, BOOST improves Time-per-Output-Token (TPOT) by 4.3% over HBM-only serving, whereas prefetching degrades TPOT by 6%.
- In high-throughput serving, BOOST improves throughput by 31% on average, outperforming prefetching by 15%.
...
```sh
arxiv read 2609.13592            # full paper as Markdown (github.com/1jmdev/arxiv)
arxiv section 2609.13592 "method"
arxiv bibtex 2609.13592
```
