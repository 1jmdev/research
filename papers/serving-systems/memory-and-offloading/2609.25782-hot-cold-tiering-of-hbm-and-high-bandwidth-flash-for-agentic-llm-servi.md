...
> **TL;DR** — This work places the hot set in HBM and the cold pool in HBF, forming a hot–cold KV hierarchy within the GPU memory tier, establishing HBF as a cold-tier complement to HBM rather than its replacement.
