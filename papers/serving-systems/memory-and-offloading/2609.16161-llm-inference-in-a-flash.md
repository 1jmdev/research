...
**arXiv:** [2609.16161](https://arxiv.org/abs/2609.16161) · [PDF](https://arxiv.org/pdf/2609.16161) · [HTML](https://arxiv.org/html/2609.16161) · **First submitted:** 2026-09-14  
**Category:** [Memory management & offloading (weights, activations)](README.md) — **rank #38 of 39** by impact score  
**Also relevant to:** [KV cache — general, systems & analysis](../../kv-cache/_general/README.md)  

> **TL;DR** — This work designs an end-to-end integer-only quantization approach to eliminate expensive floating-point computations on Flash compute-in-memory devices, and designs a dictionary-based KV cache compression strategy based on sparse dictionary coding that represents each KV vector as a linear combination of static dictionary vectors.
...
- Across Llama-3.1-8B and Qwen-2.5-7B, our combined method exhibits limited accuracy degradation while reducing dynamic KV cache traffic by 15$\times$.
...
```sh
arxiv read 2609.16161            # full paper as Markdown (github.com/1jmdev/arxiv)
arxiv section 2609.16161 "method"
arxiv bibtex 2609.16161
```
