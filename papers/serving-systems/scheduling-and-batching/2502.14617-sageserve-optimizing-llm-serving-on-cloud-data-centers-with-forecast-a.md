...
**arXiv:** [2502.14617](https://arxiv.org/abs/2502.14617) · [PDF](https://arxiv.org/pdf/2502.14617) · [HTML](https://arxiv.org/html/2502.14617) · **First submitted:** 2025-11-12  
**Category:** [Request scheduling, batching & SLO serving](README.md) — **rank #82 of 206** by impact score  
**Also relevant to:** [MoE architecture & routing](../../mixture-of-experts/architecture-and-routing/README.md)  

> **TL;DR** — SageServe is proposed, a comprehensive LLM serving framework that dynamically adapts to workload demands using multi-timescale control knobs that achieves up to 25% savings in GPU-hours compared to the current baseline deployment and reduces GPU-hour wastage due to inefficient auto-scaling by 80%, resulting in a potential monthly cost savings of up to $2.5 million.

## At a glance

| Field | Value |
| --- | --- |
| Authors | Shashwat Jaiswal, Kunal Jain, Yogesh Simmhan, Anjaly Parayil, Ankur Mallick, Rujia Wang, Renee St. Amant, Chetan Bansal, Victor Rühle, Anoop Kulkarni, … (+2) |
...
| arXiv comments | 25 pages, 16 figures, 2 tables. The workload traces, our simulator harness and the SageServe scheduler are available at https://github.com/shashwatj07/SageServe |
...
- We achieve up to 25% savings in GPU-hours compared to the current baseline deployment and reduce GPU-hour wastage due to inefficient auto-scaling by 80%, resulting in a potential monthly cost savings of up to $2.5 million, while maintaining tail latency and meeting SLAs.
...
```sh
arxiv read 2502.14617            # full paper as Markdown (github.com/1jmdev/arxiv)
arxiv section 2502.14617 "method"
arxiv bibtex 2502.14617
```
