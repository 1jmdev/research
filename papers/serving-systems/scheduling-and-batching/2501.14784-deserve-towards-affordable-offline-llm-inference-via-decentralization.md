...
> **TL;DR** — The proposed system, DeServe, decentralizes access to LLMs at a lower cost by utilizing idle GPU resources, and addresses key challenges in optimizing serving throughput in high-latency network environments.
