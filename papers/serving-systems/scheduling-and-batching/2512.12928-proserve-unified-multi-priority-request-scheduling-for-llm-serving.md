...
**Category:** [Request scheduling, batching & SLO serving](README.md) — **rank #166 of 206** by impact score  

> **TL;DR** — This work proposes ProServe, a unified two-tier scheduling framework designed to maximize overall service gain, and shows that ProServe outperforms state-of-the-art baselines, improving system gain by up to 35% and SLO attainment by up to 52%.
