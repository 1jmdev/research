...
**Category:** [Request scheduling, batching & SLO serving](README.md) — **rank #24 of 206** by impact score  

> **TL;DR** — A simple metric called Tail Inflated Expectation (TIE) is proposed to replace the output length in SJF scheduling, which adjusts the expectation of a log-t distribution with its tail probabilities to account for the risk that a request generates long outputs.
