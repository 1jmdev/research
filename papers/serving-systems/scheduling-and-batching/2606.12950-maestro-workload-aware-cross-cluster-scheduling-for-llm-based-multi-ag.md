...
> **TL;DR** — Maestro is presented, a workload-aware scheduling system designed for LLM-MAS serving under strict GPU budgets that explicitly leverages agent semantics and roles and predicts the output length and memory usage of each stage and uses this prediction to drive a hierarchical scheduler.
