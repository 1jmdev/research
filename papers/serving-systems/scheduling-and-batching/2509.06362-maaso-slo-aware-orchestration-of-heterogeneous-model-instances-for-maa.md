...
> **TL;DR** — MaSO, the first MaaS Orchestrator, is proposed, which comprises three modules: a profiler characterizing instance performance under diverse parallelism strategies and inference batch sizes; a placer optimizing heterogeneous instance configurations; and a distributor enabling SLO-aware request distribution and preventing cascaded timeouts in continuous batching.
