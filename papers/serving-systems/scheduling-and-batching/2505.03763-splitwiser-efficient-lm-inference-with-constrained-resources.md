...
**Category:** [Request scheduling, batching & SLO serving](README.md) — **rank #61 of 206** by impact score  

> **TL;DR** — This report proposes Splitwiser, a methodology that splits the two phases of an LLM inference request onto the same GPU, thereby reducing overhead and improving memory access and cache utilization and implementing the proposed multiprocessing design on two widely-used and independent LLM architectures.
