...
**Category:** [Request scheduling, batching & SLO serving](README.md) — **rank #45 of 206** by impact score  

> **TL;DR** — PolyServe is proposed, a novel multi-SLO scheduling policy at scale that maintains high SLO attainment while maximizing throughput and achieves 1.23x goodput gain compared to existing policies.
