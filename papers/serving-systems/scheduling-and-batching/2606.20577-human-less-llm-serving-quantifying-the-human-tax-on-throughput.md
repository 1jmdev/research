...
**Category:** [Request scheduling, batching & SLO serving](README.md) — **rank #186 of 206** by impact score  
**Also relevant to:** [Serving & inference systems — general](../_general/README.md)  

> **TL;DR** — This work term the unconstrained optimum human-less serving and provides a prototype demonstrating that it is practical on real workloads, and argues that serving systems should expose workload-class-aware SLA configurations rather than silently applying the human tax uniformly to all traffic.
