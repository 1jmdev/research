...
**Category:** [Request scheduling, batching & SLO serving](README.md) — **rank #62 of 206** by impact score  

> **TL;DR** — FairBatching, a novel LLM inference scheduler that enforces fair resource allocation between prefill and decode tasks, features an adaptive batch capacity determination mechanism, which dynamically adjusts the computational budget to improve the GPU utilization without triggering SLO violations.
