...
> **TL;DR** — RouteBalance is presented, a serving-aware scheduling layer that fuses both model routers and load balancers into a single online assignment over concrete model instances, jointly trading off quality, latency, and cost.
