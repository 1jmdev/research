...
> **TL;DR** — GoodServe is proposed, a goodput-optimized serving system for agentic inferences over heterogeneous resources that estimates the request output lengths as well as the GPU serving status in an accurate and practical manner and makes high-quality routing decisions using a just-enough instance selection heuristic.
