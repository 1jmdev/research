...
**arXiv:** [2603.12831](https://arxiv.org/abs/2603.12831) · [PDF](https://arxiv.org/pdf/2603.12831) · [HTML](https://arxiv.org/html/2603.12831) · **First submitted:** 2026-03-17  
**Category:** [Request scheduling, batching & SLO serving](README.md) — **rank #150 of 206** by impact score  

> **TL;DR** — OmniServe is a novel LLM serving system that efficiently harnesses both CPU and GPU resources to mitigate interference and improve throughput, and Central to OmniServe is the Attention Piggybacking mechanism, which effectively offloads the Attention computation of BE services to CPUs on the fly.
...
- Experimental results show that OmniServe improves the SLO attainment rate for LS services by up to $1.48\times$ while enhancing BE serving throughput by up to $9.85\times$ compared to state-of-the-art systems.
...
```sh
arxiv read 2603.12831            # full paper as Markdown (github.com/1jmdev/arxiv)
arxiv section 2603.12831 "method"
arxiv bibtex 2603.12831
```
