...
**Category:** [Request scheduling, batching & SLO serving](README.md) — **rank #127 of 206** by impact score  
**Also relevant to:** [Distributed inference & parallelism (TP/PP/SP/CP/EP)](../distributed-inference-and-parallelism/README.md)  

> **TL;DR** — This paper proposes to constrain certain LoRA factors to be block-diagonal, which allows for an alternative way of sharding LoRA adapters that does not require any additional communication for the LoRA computations and leads to significant end-to-end speed-up over S-LoRA.
