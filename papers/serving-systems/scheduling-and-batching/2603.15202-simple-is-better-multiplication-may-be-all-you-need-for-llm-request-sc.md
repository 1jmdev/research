...
> **TL;DR** — This paper shows that using a simple multiplication of two carefully chosen indicators, as the scheduling score (LMETRIC) can achieve both objectives simultaneously without any hyperparameter tuning, and derives the mathematical conditions under which multiplication may fail.
