...
> **TL;DR** — A performance evaluation of MLX, focusing on inference latency of transformer models, and evaluates the performance of BERT, RoBERTa, and XLM-RoBERTa models, with the intention of extending future work to include models of different modalities, thus providing a more comprehensive assessment of MLX's capabilities.
