...
**arXiv:** [2609.05764](https://arxiv.org/abs/2609.05764) · [PDF](https://arxiv.org/pdf/2609.05764) · [HTML](https://arxiv.org/html/2609.05764) · **First submitted:** 2026-09-04  
**Category:** [Hardware accelerators (ASIC, FPGA, PIM, NPU, photonic)](README.md) — **rank #116 of 203** by impact score  
...
> **TL;DR** — The architecture stores the quantized KV cache in dense on-chip NVM, uses a small static analog crossbar only for the fixed rotation, and keeps attention in on-chip digital logic.
...
| Venue | ICCAD 2026 |
| arXiv comments | IEEE/ACM International Conference on Computer-Aided Design (ICCAD 2026) |
...
- Dequantization is a sixteen-entry lookup and one norm multiply; the only per-vector metadata is one scalar, about 3%.
- Across models from 3B to 14B and contexts to 32k tokens, the four-bit KV cache maintains accuracy under storage and crossbar noise simulated at realistic device levels.
- KIVI and KVQuant remain more accurate in software; the advantage of our format lies at the memory interface: 3.1-3.6x lower KV read energy than both mapped to the same NVM, and 8x lower metadata overhead than KIVI.
...
```sh
arxiv read 2609.05764            # full paper as Markdown (github.com/1jmdev/arxiv)
arxiv section 2609.05764 "method"
arxiv bibtex 2609.05764
```
