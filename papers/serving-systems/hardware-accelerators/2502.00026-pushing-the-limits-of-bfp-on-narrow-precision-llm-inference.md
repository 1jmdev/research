...
**Category:** [Hardware accelerators (ASIC, FPGA, PIM, NPU, photonic)](README.md) — **rank #75 of 203** by impact score  

> **TL;DR** — A hardware-software co-design framework (DB-Attn) is introduced, including an advanced BFP version that overcomes nonlinear operation challenges with a pivot-focus strategy for diverse data and an adaptive grouping strategy for flexible exponent sharing, and results show that DB-Attn provides significant performance improvements with negligible accuracy loss.
