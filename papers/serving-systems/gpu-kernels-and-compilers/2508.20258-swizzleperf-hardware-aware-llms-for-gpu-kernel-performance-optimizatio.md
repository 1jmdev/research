...
**arXiv:** [2508.20258](https://arxiv.org/abs/2508.20258) · [PDF](https://arxiv.org/pdf/2508.20258) · [HTML](https://arxiv.org/html/2508.20258) · **First submitted:** 2025-08-27  
**Category:** [GPU kernels, compilers & operator optimization](README.md) — **rank #70 of 154** by impact score  

> **TL;DR** — SwizzlePerf automatically generates spatial optimizations for GPU kernels on disaggregated architectures by giving LLMs explicit hardware-awareness, the first of many steps toward systematically creating hardware-aware LLM performance engineering agents.
...
- On a suite of 10 diverse ML and Science kernels, SwizzlePerf can generate swizzling patterns for 9 of the kernels that achieve up to a 2.06x speedup and 70% improvement in L2 hit rate.
...
```sh
arxiv read 2508.20258            # full paper as Markdown (github.com/1jmdev/arxiv)
arxiv section 2508.20258 "method"
arxiv bibtex 2508.20258
```
