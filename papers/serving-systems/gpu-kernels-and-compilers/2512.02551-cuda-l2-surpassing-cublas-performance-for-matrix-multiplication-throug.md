...
**Category:** [GPU kernels, compilers & operator optimization](README.md) — **rank #7 of 154** by impact score  

> **TL;DR** — The proposed CUDA-L2 shows that even the most performance-critical, heavily-optimized kernels like HGEMM can be improved through LLM-guided RL automation by systematically exploring configuration spaces at scales impractical for humans.
