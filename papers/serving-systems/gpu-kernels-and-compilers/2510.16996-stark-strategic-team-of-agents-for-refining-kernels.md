...
**Category:** [GPU kernels, compilers & operator optimization](README.md) — **rank #24 of 154** by impact score  

> **TL;DR** — This work introduces an LLM agentic framework for GPU kernel optimization that systematically explores the design space through multi-agent collaboration, grounded instruction, dynamic context management, and strategic search, and highlights the potential of agentic LLM frameworks to advance fully automated, scalable GPU kernel optimization.
