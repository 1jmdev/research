...
**Category:** [GPU kernels, compilers & operator optimization](README.md) — **rank #111 of 154** by impact score  

> **TL;DR** — Step-TP is introduced, a post-training dataset for tensor program optimization that provides grounded, atomic, step-level supervision with structured chain-of-thought (CoT) reasoning, enabling reliable multi-step optimization rather than outcome imitation.
