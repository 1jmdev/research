...
**Category:** [GPU kernels, compilers & operator optimization](README.md) — **rank #135 of 154** by impact score  

> **TL;DR** — EGG, an Expert-Guided Agent Framework for Kernel Generation, which incorporates expert optimization principles to guide LLMs'decisions and achieves a 2.13x average speedup over PyTorch, outperforming existing agent-based and RL-based approaches.
