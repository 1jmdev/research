...
**Category:** [GPU kernels, compilers & operator optimization](README.md) — **rank #104 of 154** by impact score  

> **TL;DR** — ML-Triton is proposed which features multi-level compilation flow and programming interface that extends triton language to support user-set compiler hint and warp level programming, enabling researchers to get good out-of-the box performance without awaiting compiler updates.
