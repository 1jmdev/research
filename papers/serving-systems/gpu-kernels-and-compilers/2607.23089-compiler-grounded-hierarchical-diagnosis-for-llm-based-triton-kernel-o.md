...
**Category:** [GPU kernels, compilers & operator optimization](README.md) — **rank #140 of 154** by impact score  
**Also relevant to:** [Hardware accelerators (ASIC, FPGA, PIM, NPU, photonic)](../hardware-accelerators/README.md)  

> **TL;DR** — This work forms kernel optimization as a progressive cross-layer diagnosis problem that links runtime symptoms to IR structure and compiler behavior before rewriting source, and presents a compiler-grounded and hierarchical optimization framework for Triton kernels.
