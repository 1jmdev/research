...
**Category:** [GPU kernels, compilers & operator optimization](README.md) — **rank #108 of 154** by impact score  

> **TL;DR** — Record-Remix-Replay is presented, a hierarchical optimization framework that combines LLM-driven evolutionary search, Bayesian optimization, and record-replay compilation techniques to efficiently explore GPU kernel optimizations from source-level implementation choices down to compiler pass ordering and runtime configuration.
