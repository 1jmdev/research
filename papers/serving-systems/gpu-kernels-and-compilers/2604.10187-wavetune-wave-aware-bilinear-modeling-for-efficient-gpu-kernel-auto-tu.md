...
**arXiv:** [2604.10187](https://arxiv.org/abs/2604.10187) · [PDF](https://arxiv.org/pdf/2604.10187) · [HTML](https://arxiv.org/html/2604.10187) · **First submitted:** 2026-04-11  
**Category:** [GPU kernels, compilers & operator optimization](README.md) — **rank #128 of 154** by impact score  

> **TL;DR** — WaveTune, a wave-aware framework for runtime kernel auto-tuning, introduces a unified mapping method to handle input diversity and decompose the configuration space to manage high dimensionality, and develops an analytical wave-aware bilinear model that accurately predicts kernel latency.
...
- Across three representative kernels and five GPU architectures, WaveTune consistently achieves near-optimal kernel performance, delivering up to 1.83x kernel-level speedup and up to 1.33x end-to-end TTFT reduction, while reducing runtime decision overhead by five orders of magnitude compared to exhaustive search.
...
```sh
arxiv read 2604.10187            # full paper as Markdown (github.com/1jmdev/arxiv)
arxiv section 2604.10187 "method"
arxiv bibtex 2604.10187
```
