...
**arXiv:** [2607.02391](https://arxiv.org/abs/2607.02391) · [PDF](https://arxiv.org/pdf/2607.02391) · [HTML](https://arxiv.org/html/2607.02391) · **First submitted:** 2026-07-02  
**Category:** [Energy, carbon & cost of LLM inference/training](README.md) — **rank #41 of 69** by impact score  
**Also relevant to:** [Serving & inference systems — general](../_general/README.md)  

> **TL;DR** — This work introduces WattGPU, featuring two predictive models for mean GPU power draw and Inter-Token Latency (ITL), and leverages only publicly available LLM metadata and GPU specifications, eliminating the need for hardware access or profiling while enabling generalization to unseen NVIDIA server-grade GPUs and LLMs.
...
| Venue | IJCAI 2026 |
| arXiv comments | Accepted at 1st Workshop on Sustainability and Resource-Efficiency of Artificial Intelligence @ IJCAI 2026 |
| Citations (Semantic Scholar, 2026-09-25) | 0 (0 influential) |
| Hugging Face upvotes | 0 |
| Code | https://github.com/maufadel/wattgpu |
| Impact score | 1.2 |

## Key results (claimed in abstract)

- The mean power draw model achieves a median absolute percentage error of $\leq3.4\%$ for offline and $\leq13.5\%$ for server scenarios on unseen GPUs, while the latency model achieves $\leq8.5\%$ in server mode, both maintaining strong GPU ranking correlations for server scenarios (Kendall $τ\geq0.76$).
...
```sh
arxiv read 2607.02391            # full paper as Markdown (github.com/1jmdev/arxiv)
arxiv section 2607.02391 "method"
arxiv bibtex 2607.02391
```
