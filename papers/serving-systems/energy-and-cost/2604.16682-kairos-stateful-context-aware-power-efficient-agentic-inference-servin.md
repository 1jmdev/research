...
**Category:** [Energy, carbon & cost of LLM inference/training](README.md) — **rank #45 of 69** by impact score  

> **TL;DR** — KAIROS uses agent context as a first-class control signal to jointly manage GPU frequency, per-instance concurrency, and multi-instance request placement, which enables KAIROS to save power when memory headroom exists while avoiding thrashing and preserving performance targets.
