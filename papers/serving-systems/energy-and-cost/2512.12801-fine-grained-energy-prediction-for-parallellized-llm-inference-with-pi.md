...
**Category:** [Energy, carbon & cost of LLM inference/training](README.md) — **rank #56 of 69** by impact score  

> **TL;DR** — This work introduces PIE-P, a fine-grained energy prediction framework for multi-GPU inference, including tensor, pipeline, and data parallelism, and shows that PIE-P yields accurate and fine-grained energy predictions across parallelism strategies, significantly outperforming baselines.
