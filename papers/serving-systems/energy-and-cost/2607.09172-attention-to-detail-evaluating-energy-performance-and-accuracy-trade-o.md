...
**arXiv:** [2607.09172](https://arxiv.org/abs/2607.09172) · [PDF](https://arxiv.org/pdf/2607.09172) · [HTML](https://arxiv.org/html/2607.09172) · **First submitted:** 2026-07-17  
**Category:** [Energy, carbon & cost of LLM inference/training](README.md) — **rank #46 of 69** by impact score  
**Also relevant to:** [Prefix caching & KV reuse (RAG, multi-turn, agents)](../../kv-cache/prefix-caching-and-reuse/README.md) · [Prefill/decode disaggregation & phase-aware serving](../disaggregated-prefill-decode/README.md)  

> **TL;DR** — The results show that the studied configuration options significantly impact energy and performance, mainly driven by attention type and prefix caching, while chunked prefill has a limited effect under the default vLLM serving configuration and evaluated workloads.
...
| arXiv categories | cs.SE, cs.AI, cs.PF |
| arXiv comments | Submitted at a conference |
...
```sh
arxiv read 2607.09172            # full paper as Markdown (github.com/1jmdev/arxiv)
arxiv section 2607.09172 "method"
arxiv bibtex 2607.09172
```
