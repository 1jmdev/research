...
**Category:** [Energy, carbon & cost of LLM inference/training](README.md) — **rank #38 of 69** by impact score  
**Also relevant to:** [Request scheduling, batching & SLO serving](../scheduling-and-batching/README.md)  

> **TL;DR** — This paper introduces the LLM Efficiency Benchmark, designed to simulate real-world usage conditions, and examines how factors such as model size, architecture, and concurrent request volume affect inference energy efficiency.
