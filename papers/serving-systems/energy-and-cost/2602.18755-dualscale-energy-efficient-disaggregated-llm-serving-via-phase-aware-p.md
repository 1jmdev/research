...
**Category:** [Energy, carbon & cost of LLM inference/training](README.md) — **rank #17 of 69** by impact score  
**Also relevant to:** [Request scheduling, batching & SLO serving](../scheduling-and-batching/README.md)  

> **TL;DR** — DualScale jointly optimizes placement and DVFS across prefill and decode using predictive latency and power models, and dynamically adapts GPU frequency per iteration using stage-specific control, enabling coordinated control across timescales while preserving strict serving SLOs.
