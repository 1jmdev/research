...
**Category:** [Energy, carbon & cost of LLM inference/training](README.md) — **rank #8 of 69** by impact score  
**Also relevant to:** [Request scheduling, batching & SLO serving](../scheduling-and-batching/README.md)  

> **TL;DR** — Using the vLLM inference engine, a predictive model is developed that accurately estimates inference energy consumption across unseen architectures and hardware, and is implemented as a browser extension to raise awareness of the environmental impact of generative AI.
