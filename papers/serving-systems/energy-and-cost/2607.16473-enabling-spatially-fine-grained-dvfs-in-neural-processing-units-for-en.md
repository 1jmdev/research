...
**Category:** [Energy, carbon & cost of LLM inference/training](README.md) — **rank #50 of 69** by impact score  
...
> **TL;DR** — eNPU uses a compiler-driven two-level greedy search to co-optimize instruction scheduling and per-component V/$f$ selection under SLO constraints, and introduces lightweight cross-domain communication mechanisms to mitigate synchronization overheads across components, and extends the NPU ISA for sub-mu DVFS control.
