...
**Category:** [Energy, carbon & cost of LLM inference/training](README.md) — **rank #31 of 69** by impact score  
...
> **TL;DR** — FREESH identifies the optimal configurations of balanced load serving by matching distinct GPU instance's power-throughput characteristics with predictable LLM query length and workloads and proposes FREESH to cooperatively run a group of data centers while minimizing user-specified carbon or energy objectives.
