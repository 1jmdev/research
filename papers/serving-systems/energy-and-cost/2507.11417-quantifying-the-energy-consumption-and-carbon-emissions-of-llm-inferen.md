...
**Category:** [Energy, carbon & cost of LLM inference/training](README.md) — **rank #13 of 69** by impact score  

> **TL;DR** — This work extends a high-fidelity LLM inference simulator with a GPU power model that estimates power consumption based on utilization metrics, enabling analysis across configurations like batch size, sequence length, and model parallelism and reveals how inference parameters affect energy demand and carbon footprint.
