...
**Category:** [Energy, carbon & cost of LLM inference/training](README.md) — **rank #63 of 69** by impact score  

> **TL;DR** — TokenPowerSandbox is presented, an evidence-gated workflow that combines an interpretable CPU-resident projector, short target-GPU probes, full-workload verification, and tamper-evident freeze-before-measurement provenance.
