...
**arXiv:** [2608.04458](https://arxiv.org/abs/2608.04458) · [PDF](https://arxiv.org/pdf/2608.04458) · [HTML](https://arxiv.org/html/2608.04458) · **First submitted:** 2026-08-05  
**Category:** [Serving & inference systems — general](README.md) — **rank #51 of 117** by impact score  

> **TL;DR** — This work organizes agentic workflows in a taxonomy and presents its first architectural characterization with a production study at Microsoft Azure and a controlled study of open-source frameworks, showing that agentic execution is fragmented and heterogeneous.
...
| arXiv categories | cs.AI, cs.AR, cs.OS |
...
```sh
arxiv read 2608.04458            # full paper as Markdown (github.com/1jmdev/arxiv)
arxiv section 2608.04458 "method"
arxiv bibtex 2608.04458
```
