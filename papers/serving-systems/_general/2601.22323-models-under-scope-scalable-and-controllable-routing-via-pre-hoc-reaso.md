...
**Category:** [Serving & inference systems — general](README.md) — **rank #67 of 117** by impact score  

> **TL;DR** — This paper proposes SCOPE (Scalable and Controllable Outcome Performance Estimator), a routing framework that goes beyond model selection by predicting their cost and performance, and turns routing into a dynamic decision problem, allowing users to easily control the trade-off between accuracy and cost.
