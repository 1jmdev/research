...
**Category:** [Serving & inference systems — general](README.md) — **rank #96 of 117** by impact score  
**Also relevant to:** [KV cache eviction / token selection / sparse retrieval](../../kv-cache/eviction-and-token-selection/README.md)  

> **TL;DR** — LiveServe is an interaction-aware serving system for realtime Omni-LM interaction that improves realtime serving across two Omni-LMs and mixed workloads and moves most KV reload work off the next-turn critical path.
