...
**Category:** [Serving & inference systems — general](README.md) — **rank #108 of 117** by impact score  
**Also relevant to:** [Distributed inference & parallelism (TP/PP/SP/CP/EP)](../distributed-inference-and-parallelism/README.md)  

> **TL;DR** — It is shown that the main observed problem is not slower GPU kernels, instead, CPU workloads amplify long tails in CPU-side serving stages before GPU work is submitted, and the Core Path Tail Index (CPTI) and Core Tail Suppression (CTS) are introduced.
