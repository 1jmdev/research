...
**Category:** [Serving & inference systems — general](README.md) — **rank #10 of 117** by impact score  

> **TL;DR** — OmniRouter is introduced, a fundamentally controllable routing framework for multi- LLM serving that iteratively converges toward the globally optimal query-model allocation, dynamically balancing latency minimization against quality thresholds while adhering to heterogeneous capacity constraints.
