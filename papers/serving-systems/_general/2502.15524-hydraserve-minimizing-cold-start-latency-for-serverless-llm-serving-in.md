...
**Category:** [Serving & inference systems — general](README.md) — **rank #15 of 117** by impact score  

> **TL;DR** — HydraServe is presented, a serverless LLM serving system designed to minimize cold start latency in public clouds and introduces pipeline consolidation that can merge groups of workers into individual serving endpoints to minimize resource consumption during cold starts.
