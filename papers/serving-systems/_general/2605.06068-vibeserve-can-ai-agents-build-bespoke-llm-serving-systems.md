...
**Category:** [Serving & inference systems — general](README.md) — **rank #37 of 117** by impact score  

> **TL;DR** — This paper proposes VibeServe, the first agentic loop that generates entire LLM serving stacks end-to-end, and suggests a different point in the design space for infrastructure software: generation-time specialization rather than runtime generality.
