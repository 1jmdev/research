...
**Category:** [Serving & inference systems — general](README.md) — **rank #12 of 116** by impact score  

> **TL;DR** — Dynamic routing systems for large language models balance competing objectives by adaptively selecting among independently trained models based on query characteristics, requiring careful consideration of deployment constraints and operational trade-offs.
