...
**arXiv:** [2604.07609](https://arxiv.org/abs/2604.07609) · [PDF](https://arxiv.org/pdf/2604.07609) · [HTML](https://arxiv.org/html/2604.07609) · **First submitted:** 2026-04-08  
**Category:** [Serving & inference systems — general](README.md) — **rank #91 of 117** by impact score  
**Also relevant to:** [Memory management & offloading (weights, activations)](../memory-and-offloading/README.md)  

> **TL;DR** — Blink is introduced, an end-to-end serving architecture that removes the host CPU from the steady-state inference path by redistributing responsibilities across a SmartNIC and a GPU and replaces host-driven scheduling with a persistent GPU kernel that performs batching, scheduling, and KV-cache management without CPU involvement.
...
| arXiv categories | cs.DC, cs.LG, cs.OS, cs.PF, cs.SE |
...
- Evaluated against TensorRT-LLM, vLLM, and SGLang, Blink outperforms all baselines even in isolation, reducing pre-saturation P99 TTFT by up to 8.47$\times$ and P99 TPOT by up to 3.40$\times$, improving decode throughput by up to 2.1$\times$, and reducing energy per token by up to 48.6$\%$.
...
```sh
arxiv read 2604.07609            # full paper as Markdown (github.com/1jmdev/arxiv)
arxiv section 2604.07609 "method"
arxiv bibtex 2604.07609
```
