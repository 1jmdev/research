...
**Category:** [Serving & inference systems — general](README.md) — **rank #34 of 117** by impact score  

> **TL;DR** — This work presents M*, a universal serving system for efficient serving of composite AI models, and calls this abstraction the Walk Graph, a modular abstraction that supports arbitrary composition of model components, flexible placement onto a physical cluster, and model-agnostic optimizations within a distributed runtime.
