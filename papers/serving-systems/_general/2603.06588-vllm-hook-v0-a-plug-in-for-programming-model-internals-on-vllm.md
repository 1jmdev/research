...
**Category:** [Serving & inference systems — general](README.md) — **rank #42 of 117** by impact score  

> **TL;DR** — The core functions of vLLM Hook are presented, an opensource plug-in to enable the programming of internal states for vLLM models and 3 use cases are demonstrated including prompt injection detection, enhanced retrieval-augmented retrieval (RAG), and activation steering.
