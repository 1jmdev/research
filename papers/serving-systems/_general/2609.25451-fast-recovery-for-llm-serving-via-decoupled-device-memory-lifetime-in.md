...
**arXiv:** [2609.25451](https://arxiv.org/abs/2609.25451) · [PDF](https://arxiv.org/pdf/2609.25451) · [HTML](https://arxiv.org/html/2609.25451) · **First submitted:** 2026-09-21  
**Category:** [Serving & inference systems — general](README.md) — **rank #85 of 117** by impact score  

> **TL;DR** — This work argues that the dominant cost is loss of ready serving capacity, not request progress, so recovery should preserve initialized engine state rather than reconstruct it, and presents fast recovery for Dynamo based on this principle.
...
| arXiv comments | 16 pages, 12 figures. Open-source implementations: https://github.com/ai-dynamo/dynamo and https://github.com/ai-dynamo/snapshot |
...
- Across four models on vLLM and SGLang, these mechanisms recover a failed replica in under 7 seconds, 13-29 times faster than a warm restart, using a fixed 4-8 GiB of device memory per GPU independent of model size.
- Replaying the production trace, we estimate they would reclaim 79% of GPU-hours lost to recovery.
...
```sh
arxiv read 2609.25451            # full paper as Markdown (github.com/1jmdev/arxiv)
arxiv section 2609.25451 "method"
arxiv bibtex 2609.25451
```
