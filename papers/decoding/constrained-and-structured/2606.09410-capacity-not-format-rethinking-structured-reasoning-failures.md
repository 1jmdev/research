...
> **TL;DR** — It is found that structured formats are capacity-dependent, and format-specific effects from prompt-length confounds across 4 models and 5 benchmarks with 0% parse failures on successfully generated responses are separated.
