...
**arXiv:** [2604.25359](https://arxiv.org/abs/2604.25359) · [PDF](https://arxiv.org/pdf/2604.25359) · [HTML](https://arxiv.org/html/2604.25359) · **First submitted:** 2026-04-28  
**Category:** [Constrained & structured decoding](README.md) — **rank #16 of 47** by impact score  

> **TL;DR** — This work introduces SOB (The Structured Output Benchmark), a multi-source benchmark spanning three source modalities: native text, images, and audio conversations, and evaluates 21 frontier and open-weight models across three source domains and seven metrics.
...
| Venue | NeurIPS 2026 |
| arXiv comments | 19 pages, 4 figures, 11 tables, submitted to NeurIPS 2026 |
...
- Our results reveal a consistent pattern: models achieve near-perfect schema compliance, yet the best Value Accuracy, measured by exact leaf-value match, reaches only 83.0% on text, 67.2% on images, and 23.7% on audio, where longer context makes extraction substantially harder.
...
```sh
arxiv read 2604.25359            # full paper as Markdown (github.com/1jmdev/arxiv)
arxiv section 2604.25359 "method"
arxiv bibtex 2604.25359
```
