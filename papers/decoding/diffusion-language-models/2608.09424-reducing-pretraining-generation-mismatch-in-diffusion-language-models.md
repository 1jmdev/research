...
**arXiv:** [2608.09424](https://arxiv.org/abs/2608.09424) · [PDF](https://arxiv.org/pdf/2608.09424) · [HTML](https://arxiv.org/html/2608.09424) · **First submitted:** 2026-08-10  
**Category:** [Diffusion language models (dLLMs) — models & training](README.md) — **rank #340 of 351** by impact score  
**Also relevant to:** [Pre-training recipes & efficiency](../../training/pretraining-recipes-and-efficiency/README.md)  

> **TL;DR** — This work proposes PCD (Prefix-Conditioned Diffusion), a pretraining objective that combines AR prefix supervision with no-shift suffix denoising and suggests that aligning the pretraining context distribution with prompt-conditioned generation can recover a measurable part of the dLLM continuation gap without changing inference.
...
| arXiv comments | 12 pages, 9 figures, 1 table |
...
- Across LLaDA2-Mini and Qwen-1.7B backbones, PCD consistently improves over same-family native dLLM stable baselines, reaching a 4.2% relative gain on the main LLaDA2-Mini six-benchmark average (+2.56 points) and a 14.2% relative gain in the primary Qwen mechanism comparison (+4.86 points).
...
```sh
arxiv read 2608.09424            # full paper as Markdown (github.com/1jmdev/arxiv)
arxiv section 2608.09424 "method"
arxiv bibtex 2608.09424
```
