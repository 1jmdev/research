...
**arXiv:** [2609.01043](https://arxiv.org/abs/2609.01043) · [PDF](https://arxiv.org/pdf/2609.01043) · [HTML](https://arxiv.org/html/2609.01043) · **First submitted:** 2026-09-01  
**Category:** [Diffusion language models (dLLMs) — models & training](README.md) — **rank #344 of 351** by impact score  
...
| arXiv categories | cs.LG, cs.AI, math.PR, stat.ML |
...
- Under the same finalization rule, CRS without top-$p$ truncation reaches lower generative perplexity (GenPPL) than fixed $p=0.95$ and $p=0.9$ baselines across budgets of 8--64 function evaluations (NFE).
...
```sh
arxiv read 2609.01043            # full paper as Markdown (github.com/1jmdev/arxiv)
arxiv section 2609.01043 "method"
arxiv bibtex 2609.01043
```
