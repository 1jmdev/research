...
**Category:** [Diffusion language models (dLLMs) — models & training](README.md) — **rank #264 of 351** by impact score  

> **TL;DR** — The main result is a diagnostic one: latent geometry alone is not enough for continuous latent text generation; local flow refinement and fused decoder-aware readout give modest additional gains, while metric learning and OT-style alignment improve geometry but do not close the decoder gap.
