...
**arXiv:** [2609.09338](https://arxiv.org/abs/2609.09338) · [PDF](https://arxiv.org/pdf/2609.09338) · [HTML](https://arxiv.org/html/2609.09338) · **First submitted:** 2026-09-08  
**Category:** [Speculative decoding (draft–verify)](README.md) — **rank #172 of 316** by impact score  
**Also relevant to:** [Pre-training recipes & efficiency](../../training/pretraining-recipes-and-efficiency/README.md)  

> **TL;DR** — Osprey bootstraps drafters from off-the-shelf pretrained small language models, treating broad pretraining as a reusable, target-agnostic asset and reducing per-target work to a lightweight adaptation step, and addresses two challenges: small LMs are far deeper than a latency-bound drafter can afford and their pretrained computation must remain intact while the drafter learns to ingest target hidden states and emit tokens in the target's vocabulary.
...
| arXiv comments | Accepted at EMNLP 2026. 21 pages, 4 figures |
...
| Models used | Llama-3.3-70B, Qwen3-8B |
| Impact score | 1.2 |

## Key results (claimed in abstract)

- Empirically, a single pretrained Osprey backbone transfers across targets and improves mean acceptance length by 16.1% for Qwen3-8B, 21.2% for Llama-3.3-70B-Instruct, and 22.7% for the 229B MiniMax-M2.5 (with 17.5% higher tokens per second), with the largest gains on out-of-domain and multilingual data.
...
```sh
arxiv read 2609.09338            # full paper as Markdown (github.com/1jmdev/arxiv)
arxiv section 2609.09338 "method"
arxiv bibtex 2609.09338
```
