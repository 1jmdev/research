...
**arXiv:** [2607.25852](https://arxiv.org/abs/2607.25852) · [PDF](https://arxiv.org/pdf/2607.25852) · [HTML](https://arxiv.org/html/2607.25852) · **First submitted:** 2026-07-29  
**Category:** [Speculative decoding (draft–verify)](README.md) — **rank #137 of 316** by impact score  
**Also relevant to:** [Multi-token prediction (MTP)](../multi-token-prediction/README.md)  

> **TL;DR** — DFly is proposed, a block-diffusion framework combining a hybrid target-conditioning backbone with a predecessor-conditioned autoregressive head, improving target-feature utilization and intra-block dependency modeling while keeping generation parallel, and DFly treats verification as a shared batch-level resource.

## At a glance

| Field | Value |
| --- | --- |
| Authors | Hong Liu, Rui Cen, Junhan Shi, Guangshuo Qin, Jiebin Zhang, Tianyu Liu, Runzhi Fan, Guoliang Zhao, Ruobing Xie, Kai Zhang, … (+3) |
...
- Across the Hy3 series, DFly raises the average accepted length on Hy3-A21B by roughly 30% and attains the highest average throughput at every tested concurrency from 4 to 64, a 1.98-2.40x speedup over autoregressive decoding and 10.5-11.8% higher throughput than DFlash.
...
```sh
arxiv read 2607.25852            # full paper as Markdown (github.com/1jmdev/arxiv)
arxiv section 2607.25852 "method"
arxiv bibtex 2607.25852
```
