...
**arXiv:** [2609.00355](https://arxiv.org/abs/2609.00355) · [PDF](https://arxiv.org/pdf/2609.00355) · [HTML](https://arxiv.org/html/2609.00355) · **First submitted:** 2026-08-31  
**Category:** [Speculative decoding (draft–verify)](README.md) — **rank #238 of 316** by impact score  

> **TL;DR** — GLANCE is presented, the first one-pass block drafter that is lossless on an unmodified VLM target, and it breaks the cycle at both ends of a self-defeating cycle.
...
| arXiv comments | 18 pages, 9 figures, 17 tables. Code: https://github.com/js-lee-AI/GLANCE |
| Citations (Semantic Scholar, 2026-09-25) | 0 (0 influential) |
| Hugging Face upvotes | 0 |
| Code | https://github.com/js-lee-AI/GLANCE |
| Impact score | 0.5 |

## Key results (claimed in abstract)

- Under one engine and one round budget, GLANCE decodes up to 2.93x faster than autoregression, from one draft pass a round where the production EAGLE3-VL head takes eight, and accepts 2.7x longer blocks than an EAGLE-3 head trained on the same corpus.
...
```sh
arxiv read 2609.00355            # full paper as Markdown (github.com/1jmdev/arxiv)
arxiv section 2609.00355 "method"
arxiv bibtex 2609.00355
```
