...
| [SimpleTool: Parallel Decoding for Real-Time LLM Function Calling](2603.00030-simpletool-parallel-decoding-for-real-time-llm-function-calling.md) | 1.0 | 4.0 | H100 | ST-Qwen-0.5B converges in approximately 3–4 H100-hours for initial training, and \sim1 GPU-hour for domain adaptation on Mobile Actions.… |
...
| 15 | [SimpleTool: Parallel Decoding for Real-Time LLM Function Calling](2603.00030-simpletool-parallel-decoding-for-real-time-llm-function-calling.md) | 2026-02-04 | 0.93 | 1 | 0 |  | [✓](https://github.com/HaxxorCialtion/SimpleTool) | SimpleTool is presented, which introduces special tokens that serve a dual role: compressing low-entropy tokens while acting as mode selectors that enable … |
