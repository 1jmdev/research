...
**Category:** [Sampling & decoding strategies](README.md) — **rank #32 of 42** by impact score  

> **TL;DR** — This paper proposes AdaDec, a lookahead-based uncertainty-guided adaptive decoding framework that integrates a token-level pause-then-rerank mechanism driven by token uncertainty, which consistently outperforms both competitive baselines like Beam Search and state-of-the-art adaptive decoding methods such as AdapT.
