...
> **TL;DR** — This paper introduces a new formulation for controlled text generation by defining a joint distribution over the generated sequence and an auxiliary bias sequence, and proposes a Langevin-within-Gibbs sampling algorithm using gradient-based discrete MCMC.
