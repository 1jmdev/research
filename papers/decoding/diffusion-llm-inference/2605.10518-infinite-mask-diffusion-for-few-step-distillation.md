...
**arXiv:** [2605.10518](https://arxiv.org/abs/2605.10518) · [PDF](https://arxiv.org/pdf/2605.10518) · [HTML](https://arxiv.org/html/2605.10518) · **First submitted:** 2026-05-11  
**Category:** [Diffusion LLM inference acceleration](README.md) — **rank #167 of 203** by impact score  

> **TL;DR** — This paper proposes the Infinite Mask Diffusion Model (IMDM), which introduces a stochastic infinite-state mask to mitigate the theoretical bound while directly inheriting the benefits of MDMs, including the compatibility with pre-trained weights.
...
```sh
arxiv read 2605.10518            # full paper as Markdown (github.com/1jmdev/arxiv)
arxiv section 2605.10518 "method"
arxiv bibtex 2605.10518
```
