...
**arXiv:** [2606.16847](https://arxiv.org/abs/2606.16847) · [PDF](https://arxiv.org/pdf/2606.16847) · [HTML](https://arxiv.org/html/2606.16847) · **First submitted:** 2026-09-16  
**Category:** [Diffusion LLM inference acceleration](README.md) — **rank #151 of 203** by impact score  
**Also relevant to:** [Diffusion language models (dLLMs) — models & training](../diffusion-language-models/README.md)  

> **TL;DR** — This work proposes ASRD (Anchor Supervised Revocable Decoding), a training-free framework that operates within the embedding space and outperforms recent remasking baselines, achieving accuracy improvements of up to 6.4\% while accelerating inference throughput by up to 7.2$\times$.
...
| Code | https://github.com/preordinary/ASRD |
| Training requirement (from abstract) | training-free / post-training |
| Impact score | 0.5 |

## Key results (claimed in abstract)

- Extensive experiments on math and coding benchmarks demonstrate that ASRD outperforms recent remasking baselines, achieving accuracy improvements of up to 6.4\% while accelerating inference throughput by up to 7.2$\times$.The code is available at https://github.com/preordinary/ASRD.
...
```sh
arxiv read 2606.16847            # full paper as Markdown (github.com/1jmdev/arxiv)
arxiv section 2606.16847 "method"
arxiv bibtex 2606.16847
```
