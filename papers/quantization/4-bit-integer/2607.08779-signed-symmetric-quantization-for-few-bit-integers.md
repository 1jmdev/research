...
**arXiv:** [2607.08779](https://arxiv.org/abs/2607.08779) · [PDF](https://arxiv.org/pdf/2607.08779) · [HTML](https://arxiv.org/html/2607.08779) · **First submitted:** 2026-06-12  
**Category:** [4-bit integer quantization (INT4, W4A16, W4A8, W4A4)](README.md) — **rank #74 of 81** by impact score  

> **TL;DR** — This work establishes the signed absmax grid as conditionally bound-optimal on $\ell_2$ quantization error, and shows that the condition holds for 88-99% of weight groups across pre-trained large language models (LLMs) at low bit widths.
...
| Models used | Llama3, Qwen3, Qwen3.5, llama |
| Impact score | 0.0 |
...
```sh
arxiv read 2607.08779            # full paper as Markdown (github.com/1jmdev/arxiv)
arxiv section 2607.08779 "method"
arxiv bibtex 2607.08779
```
