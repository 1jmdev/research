...
**arXiv:** [2605.14844](https://arxiv.org/abs/2605.14844) · [PDF](https://arxiv.org/pdf/2605.14844) · [HTML](https://arxiv.org/html/2605.14844) · **First submitted:** 2026-05-14  
**Category:** [4-bit integer quantization (INT4, W4A16, W4A8, W4A4)](README.md) — **rank #51 of 81** by impact score  
**Also relevant to:** [MoE architecture & routing](../../mixture-of-experts/architecture-and-routing/README.md)  

> **TL;DR** — XFP, a dynamic weight quantizer for LLM inference that inverts the conventional workflow, is introduced and the H-Process, a quality-driven iteration over the two cosine thresholds that finds the operating point at which the model just fits while still producing sensible output is presented.
...
| arXiv comments | 17 pages, 3 figures, 17 tables, 1 algorithm. Code: https://github.com/flash7777/vllm/tree/multiquant |
| Citations (Semantic Scholar, 2026-09-25) | 0 (0 influential) |
| Hugging Face upvotes | 0 |
| Code | https://github.com/flash7777/vllm |
| Bit-widths mentioned | 4-bit |
| Models used | Qwen3.5-122B, Qwen3.5-397B |
| Impact score | 0.5 |
...
```sh
arxiv read 2605.14844            # full paper as Markdown (github.com/1jmdev/arxiv)
arxiv section 2605.14844 "method"
arxiv bibtex 2605.14844
```
