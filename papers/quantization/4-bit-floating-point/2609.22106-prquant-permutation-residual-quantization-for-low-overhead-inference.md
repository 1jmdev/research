...
**arXiv:** [2609.22106](https://arxiv.org/abs/2609.22106) · [PDF](https://arxiv.org/pdf/2609.22106) · [HTML](https://arxiv.org/html/2609.22106) · **First submitted:** 2026-08-16  
**Category:** [4-bit floating point / microscaling (FP4, MXFP4, NVFP4)](README.md) — **rank #39 of 39** by impact score  

> **TL;DR** — PRQuant (Permutation Residual Quantization), a training-free and low-overhead framework that combines channel reorganization with static weight-side residual compensation, which outperforms default MXFP4 and the evaluated PTQ baselines in average accuracy across five downstream benchmarks.

## At a glance

| Field | Value |
| --- | --- |
| Authors | Peiran Wang, Anqi Wang, Jiaying Zhao, Huiwen Yang, Zhenyu Ming, Rongqian Wang, Yiwu Yao, Kun Tian, Xin Yao, Gong Zhang, … (+2) |
...
```sh
arxiv read 2609.22106            # full paper as Markdown (github.com/1jmdev/arxiv)
arxiv section 2609.22106 "method"
arxiv bibtex 2609.22106
```
