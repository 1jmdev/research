...
**arXiv:** [2606.02288](https://arxiv.org/abs/2606.02288) · [PDF](https://arxiv.org/pdf/2606.02288) · [HTML](https://arxiv.org/html/2606.02288) · **First submitted:** 2026-06-01  
...
> **TL;DR** — This work proposes INSERTQUANT, a post-training quantization (PTQ) framework that clamps spikes and restores their function via pre-computed template vectors, enabling robust low-bit quantization with high fidelity.
...
```sh
arxiv read 2606.02288            # full paper as Markdown (github.com/1jmdev/arxiv)
arxiv section 2606.02288 "method"
arxiv bibtex 2606.02288
```
