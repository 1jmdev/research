...
**arXiv:** [2605.15572](https://arxiv.org/abs/2605.15572) · [PDF](https://arxiv.org/pdf/2605.15572) · [HTML](https://arxiv.org/html/2605.15572) · **First submitted:** 2026-06-02  
**Category:** [Quantization — general / analysis / surveys](README.md) — **rank #25 of 141** by impact score  

> **TL;DR** — It is concluded that maximum activation magnitude is a model property tied to family, architecture, and training stage - not a simple byproduct of size - and should be measured and reported alongside any open-weight release before low-bit deployment.

## At a glance

| Field | Value |
| --- | --- |
| Authors | Luxuan Chen, Han Tian, Xinran Chen, Rui Kong, Fang Wang, Jiamin Chen, Yuchen Li, Jiashu Zhao, Shuaiqiang Wang, Haoyi Xiong, … (+2) |
...
| Models used | Gemma3-27B, LLaMA-, Qwen3.5 |
| Impact score | 3.62 |
...
- A lightweight INT-8 sanity check shows that measured maxima co-vary with low-bit reconstruction error via activation-scale selection.
...
**Keywords:** activation scaling, low-bit quantization, LLM inference, outlier features, activation-quantization stack, open LLMs, INT-8, SwiGLU gates, MoE, dense models, vision-language models, instruction-tuned variants

## Reproduce / read

```sh
arxiv read 2605.15572            # full paper as Markdown (github.com/1jmdev/arxiv)
arxiv section 2605.15572 "method"
arxiv bibtex 2605.15572
```
