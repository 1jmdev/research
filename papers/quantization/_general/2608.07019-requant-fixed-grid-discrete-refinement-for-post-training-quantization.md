...
**arXiv:** [2608.07019](https://arxiv.org/abs/2608.07019) · [PDF](https://arxiv.org/pdf/2608.07019) · [HTML](https://arxiv.org/html/2608.07019) · **First submitted:** 2026-08-07  
**Category:** [Quantization — general / analysis / surveys](README.md) — **rank #136 of 141** by impact score  

> **TL;DR** — ReQuant is introduced, a backpropagation-free fixed-grid refinement procedure that takes an existing quantized model as a feasible starting point and iteratively revisits its discrete weight assignments on the fixed quantization grid, and turns the initially fixed PTQ output into an iteratively optimizable discrete solution.
...
| arXiv comments | 10 pages, 3 figures, 16 tables |
...
```sh
arxiv read 2608.07019            # full paper as Markdown (github.com/1jmdev/arxiv)
arxiv section 2608.07019 "method"
arxiv bibtex 2608.07019
```
