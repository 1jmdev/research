...
> **TL;DR** — This work proposes a new fractional bits quantization (\short) approach, which progressively reduces the model's precision from 32 to 4 bits per parameter, and exploits the fractional bits during optimization to maintain high generation quality.
