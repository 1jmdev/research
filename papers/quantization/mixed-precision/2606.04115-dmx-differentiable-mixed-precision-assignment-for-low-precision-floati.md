...
**arXiv:** [2606.04115](https://arxiv.org/abs/2606.04115) · [PDF](https://arxiv.org/pdf/2606.04115) · [HTML](https://arxiv.org/html/2606.04115) · **First submitted:** 2026-07-14  
**Category:** [Mixed-precision & bit allocation](README.md) — **rank #10 of 48** by impact score  

> **TL;DR** — dMX, a differentiable mixed-precision quantization framework for learnable floating-point bit-width assignment, is introduced, and its application for the microscaling floating-point (MXFP) family of data types defined by the Open Compute Project (OCP) standard is studied.
...
```sh
arxiv read 2606.04115            # full paper as Markdown (github.com/1jmdev/arxiv)
arxiv section 2606.04115 "method"
arxiv bibtex 2606.04115
```
