...
**Category:** [Low-precision training (FP8 / FP4 / INT8 training)](README.md) — **rank #47 of 64** by impact score  

> **TL;DR** — A Bayesian learning rule is derived that assumes log-normal posterior distributions over weights which gives rise to a new Log-Normal Multiplicative Dynamics (LMD) algorithm, which achieves stable and accurate training-from-scratch under low-precision forward operations for Vision Transformer and GPT-2.
