...
**Category:** [Low-precision training (FP8 / FP4 / INT8 training)](README.md) — **rank #41 of 64** by impact score  
**Also relevant to:** [Quantization — general / analysis / surveys](../_general/README.md)  

> **TL;DR** — STQuant is a distributed training framework that reduces the memory footprint of optimizer states via dynamic precision allocation across layers, state variables, and training steps, while maintaining model quality.
