...
**arXiv:** [2602.10959](https://arxiv.org/abs/2602.10959) · [PDF](https://arxiv.org/pdf/2602.10959) · [HTML](https://arxiv.org/html/2602.10959) · **First submitted:** 2026-02-11  
**Category:** [Long context, context extension & positional encoding](README.md) — **rank #71 of 189** by impact score  

> **TL;DR** — This work reinterprets RoPE as phase modulation applied to a bank of complex oscillators, enabling analysis through classical signal processing theory and derive principled lower bounds on the RoPE base parameter that are necessary to preserve positional coherence over a target context length.
...
```sh
arxiv read 2602.10959            # full paper as Markdown (github.com/1jmdev/arxiv)
arxiv section 2602.10959 "method"
arxiv bibtex 2602.10959
```
