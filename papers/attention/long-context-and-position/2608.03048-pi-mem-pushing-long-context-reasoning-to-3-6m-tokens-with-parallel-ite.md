...
**arXiv:** [2608.03048](https://arxiv.org/abs/2608.03048) · [PDF](https://arxiv.org/pdf/2608.03048) · [HTML](https://arxiv.org/html/2608.03048) · **First submitted:** 2026-08-04  
**Category:** [Long context, context extension & positional encoding](README.md) — **rank #182 of 189** by impact score  

> **TL;DR** — It is demonstrated that PI-Mem breaks the accuracy--efficiency trade-off in long-context reasoning and provides a scalable approach to complex multi-hop question answering over extremely long documents.

## At a glance

| Field | Value |
| --- | --- |
| Authors | Dawei Liu, Haixu Song, Shuang Cheng, Shijie Wang, Haozheng Hou, Kaifeng Liu, Ermo Hua, Zhonghang Yuan, Zhijie Zhong, Yuchen Fan, … (+2) |
| arXiv categories | cs.CL, cs.AI |
| Citations (Semantic Scholar, 2026-09-25) | 0 (0 influential) |
| Hugging Face upvotes | 0 |
| Code | — |
| Models used | Qwen2.5-7B, Qwen3.5-35B |
| Impact score | 0.0 |

## Key results (claimed in abstract)

- We evaluate PI-Mem with Qwen3.5-35B-A3B and Qwen2.5-7B on the HotpotQA benchmark across context lengths up to 3.6 million tokens and find that it outperforms the recurrent-memory baseline by +6.25 and +7.81 absolute points while achieving 6.1$\times$ and 2.1$\times$ inference speedups, respectively.
...
```sh
arxiv read 2608.03048            # full paper as Markdown (github.com/1jmdev/arxiv)
arxiv section 2608.03048 "method"
arxiv bibtex 2608.03048
```
