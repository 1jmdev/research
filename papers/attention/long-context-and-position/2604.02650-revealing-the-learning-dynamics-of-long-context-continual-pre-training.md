...
**arXiv:** [2604.02650](https://arxiv.org/abs/2604.02650) · [PDF](https://arxiv.org/pdf/2604.02650) · [HTML](https://arxiv.org/html/2604.02650) · **First submitted:** 2026-04-03  
**Category:** [Long context, context extension & positional encoding](README.md) — **rank #140 of 189** by impact score  
**Also relevant to:** [Pre-training recipes & efficiency](../../training/pretraining-recipes-and-efficiency/README.md)  

> **TL;DR** — This work presents the first systematic investigation of LCCP learning dynamics using the industrial-grade Hunyuan-A13B (80B total parameters), tracking its evolution across a 200B-token training trajectory and proposes a hierarchical framework to analyze LCCP dynamics across behavioral, probabilistic, and mechanistic levels.
...
```sh
arxiv read 2604.02650            # full paper as Markdown (github.com/1jmdev/arxiv)
arxiv section 2604.02650 "method"
arxiv bibtex 2604.02650
```
