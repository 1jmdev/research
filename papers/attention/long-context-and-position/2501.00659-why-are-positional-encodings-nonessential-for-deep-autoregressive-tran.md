...
**Category:** [Long context, context extension & positional encoding](README.md) — **rank #68 of 189** by impact score  

> **TL;DR** — The long-forgotten explanation why explicit PEs are nonessential for multi-layer autoregressive Transformers (in contrast, one-layer models require PEs to discern order information of their inputs) is reviewed, as well as the origin of this result, and it is hoped to re-establish it as a common knowledge.
