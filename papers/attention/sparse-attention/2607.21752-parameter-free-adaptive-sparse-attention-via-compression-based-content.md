...
**arXiv:** [2607.21752](https://arxiv.org/abs/2607.21752) · [PDF](https://arxiv.org/pdf/2607.21752) · [HTML](https://arxiv.org/html/2607.21752) · **First submitted:** 2026-07-23  
**Category:** [Sparse attention (trainable & training-free)](README.md) — **rank #165 of 180** by impact score  
**Also relevant to:** [GPU kernels, compilers & operator optimization](../../serving-systems/gpu-kernels-and-compilers/README.md)  

> **TL;DR** — This work shows that classical data compression provides an effective masking signal with no additional parameters, and identifies non-redundant content blocks and route long-range attention selectively through them by computing per-block gzip compression ratios.
...
- On PG-19 byte-level language modeling at 92M parameters with 8K context, our method achieves 1.71 bits-per-byte (BPB), outperforming dense attention (2.89), BigBird (2.34), Longformer (3.21), and a reimplemented SBM-Transformer (3.38)---the only learned-mask baseline---by up to 1.67 BPB while adding no parameters.
...
```sh
arxiv read 2607.21752            # full paper as Markdown (github.com/1jmdev/arxiv)
arxiv section 2607.21752 "method"
arxiv bibtex 2607.21752
```
