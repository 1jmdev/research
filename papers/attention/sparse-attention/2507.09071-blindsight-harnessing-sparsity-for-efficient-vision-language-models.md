...
**Category:** [Sparse attention (trainable & training-free)](README.md) — **rank #144 of 180** by impact score  

> **TL;DR** — This work utilizes a dataset to derive a prompt-agnostic categorization for attention heads: Dense, Sink, Intra-Image, and Intra-Image+Sink, and develops a Triton-based GPU kernel to leverage this sparsity.
