...
**arXiv:** [2609.02737](https://arxiv.org/abs/2609.02737) · [PDF](https://arxiv.org/pdf/2609.02737) · [HTML](https://arxiv.org/html/2609.02737) · **First submitted:** 2026-09-02  
**Category:** [Sparse attention (trainable & training-free)](README.md) — **rank #28 of 180** by impact score  

> **TL;DR** — Declarative Attention is introduced, a protocol that elicits the model to declare where it needs to attend within its chain-of-thought, partitioning generation into three modes:(full context),(a specific region), and(recent output only).
...
| Code | — |
| Models used | Gemma-, Qwen-3.6-27B |
| Impact score | 6.33 |
...
**Keywords:** Declarative Attention, KV cache, chain-of-thought, global attention, sparse attention, long-context

## Reproduce / read

```sh
arxiv read 2609.02737            # full paper as Markdown (github.com/1jmdev/arxiv)
arxiv section 2609.02737 "method"
arxiv bibtex 2609.02737
```
