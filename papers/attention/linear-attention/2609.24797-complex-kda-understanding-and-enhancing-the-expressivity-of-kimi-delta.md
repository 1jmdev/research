...
**arXiv:** [2609.24797](https://arxiv.org/abs/2609.24797) · [PDF](https://arxiv.org/pdf/2609.24797) · [HTML](https://arxiv.org/html/2609.24797) · **First submitted:** 2026-09-21  
**Category:** [Linear attention & kernelized attention](README.md) — **rank #24 of 84** by impact score  

> **TL;DR** — This work shows that Kimi Delta Attention (KDA) can realize 2D rotations by combining a single delta-rule transformation with a second reflection supplied by its channel-wise gate, and characterize the expressivity of CKDA and prove that every orthogonal diagonal-plus-rank-one matrix is exactly a CKDA transition matrix.

## At a glance

| Field | Value |
| --- | --- |
| Authors | Julien Siems, Riccardo Grazzi, Korbinian Pöppel, Jaisidh Singh, Arber Zela, Timur Carstensen, Jenia Jitsev, Frank Hutter, Volkan Cevher, Antonio Orvieto, … (+1) |
| Organisation (HF) | OpenEuroLLM |
...
```sh
arxiv read 2609.24797            # full paper as Markdown (github.com/1jmdev/arxiv)
arxiv section 2609.24797 "method"
arxiv bibtex 2609.24797
```
