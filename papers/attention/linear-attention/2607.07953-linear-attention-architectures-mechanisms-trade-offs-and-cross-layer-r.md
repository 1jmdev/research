...
**arXiv:** [2607.07953](https://arxiv.org/abs/2607.07953) · [PDF](https://arxiv.org/pdf/2607.07953) · [HTML](https://arxiv.org/html/2607.07953) · **First submitted:** 2026-07-08  
**Category:** [Linear attention & kernelized attention](README.md) — **rank #21 of 84** by impact score  
...
| arXiv comments | 20 pages, 6 figures, 8 tables. Code available at https://github.com/tommasocerruti/linear-attention-architectures |
| Citations (Semantic Scholar, 2026-09-25) | 0 (0 influential) |
| Hugging Face upvotes | 13 |
| Code | https://github.com/tommasocerruti/linear-attention-architectures |
...
**Keywords:** self-attention, softmax attention, recurrent linear-attention, DeltaNet, Gated DeltaNet, Kimi Delta Attention, Gated DeltaNet-2, recurrent-memory notation, memory decay, erase and write control, training throughput, implementation complexity

## Reproduce / read

```sh
arxiv read 2607.07953            # full paper as Markdown (github.com/1jmdev/arxiv)
arxiv section 2607.07953 "method"
arxiv bibtex 2607.07953
```
