...
**Category:** [Data curation, mixtures & synthetic data](README.md) — **rank #242 of 247** by impact score  
**Also relevant to:** [Pre-training recipes & efficiency](../pretraining-recipes-and-efficiency/README.md)  

> **TL;DR** — Experiments show that SPT consistently improves agentic performance over mid-training on general or trajectory data, while largely preserving general performance, indicating that skill packages are a valuable data source for pre-training agentic language models.
