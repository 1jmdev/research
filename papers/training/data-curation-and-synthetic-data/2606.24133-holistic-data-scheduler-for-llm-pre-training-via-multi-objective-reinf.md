...
**Category:** [Data curation, mixtures & synthetic data](README.md) — **rank #85 of 247** by impact score  
...
> **TL;DR** — The Holistic Data Scheduler (HDS) is introduced, a novel online data mixing framework that formulates the data scheduling challenge as a reinforcement learning problem in a continuous control space and leverages the Soft Actor-Critic algorithm for its stability and sample efficiency in exploring the high-dimensional policy space.
