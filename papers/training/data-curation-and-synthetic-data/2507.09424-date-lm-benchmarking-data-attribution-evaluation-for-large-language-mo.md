...
**Category:** [Data curation, mixtures & synthetic data](README.md) — **rank #135 of 247** by impact score  

> **TL;DR** — DATE-LM (Data Attribution Evaluation in Language Models), a unified benchmark for evaluating data attribution methods through real-world LLM applications, is introduced, showing that no single method dominates across all tasks, data attribution methods have trade-offs with simpler baselines, and method performance is sensitive to task-specific evaluation design.
