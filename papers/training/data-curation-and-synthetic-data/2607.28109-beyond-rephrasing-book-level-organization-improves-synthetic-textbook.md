...
**Category:** [Data curation, mixtures & synthetic data](README.md) — **rank #187 of 247** by impact score  

> **TL;DR** — A scalable synthesis pipeline and controlled evidence that whether related content is organized into coherent book-level documents matters are contributed, supporting book-level organization as a useful axis for synthetic pre-training data design.
