...
**Category:** [Data curation, mixtures & synthetic data](README.md) — **rank #182 of 247** by impact score  

> **TL;DR** — A fine-grained categorization of existing data mixture methods is proposed, extending beyond the previous offline and online classification, and grouping offline methods into heuristic-based, algorithm-based, and function fitting-based methods.
