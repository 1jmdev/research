...
**Category:** [Data curation, mixtures & synthetic data](README.md) — **rank #132 of 247** by impact score  

> **TL;DR** — This work proposes PiKE (Positive gradient interaction-based K-task weights Estimator) an adaptive data mixing algorithm that dynamically adjusts sampling weights during training and extends PiKE to promote balanced learning across tasks.
