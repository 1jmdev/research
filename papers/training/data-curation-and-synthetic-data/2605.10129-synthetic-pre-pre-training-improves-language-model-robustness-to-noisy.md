...
**Category:** [Data curation, mixtures & synthetic data](README.md) — **rank #186 of 247** by impact score  
**Also relevant to:** [Pre-training recipes & efficiency](../pretraining-recipes-and-efficiency/README.md)  

> **TL;DR** — Mechanistic analyses suggest PPT does not immediately suppress attention to noisy tokens, but PPT-initialized models gradually downweight attention between corrupted tokens during noisy PT, which indicates that synthetic PPT inhibits noise self-modeling and shapes the subsequent optimization trajectory.
