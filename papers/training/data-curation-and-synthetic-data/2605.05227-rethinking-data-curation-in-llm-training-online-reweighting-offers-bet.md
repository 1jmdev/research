...
**Category:** [Data curation, mixtures & synthetic data](README.md) — **rank #177 of 247** by impact score  

> **TL;DR** — This work introduces ADAPT (Adaptive Data reweighting for Pretraining and FineTuning), a dynamic online framework that reweights training samples with adaptive per-sample learning rates guided by similarity-based quality signals, without changing the number of training samples.
