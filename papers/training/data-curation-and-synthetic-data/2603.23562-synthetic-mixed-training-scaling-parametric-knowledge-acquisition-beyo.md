...
**Category:** [Data curation, mixtures & synthetic data](README.md) — **rank #212 of 247** by impact score  

> **TL;DR** — Synthetic Mixed Training is introduced, which combines synthetic QAs and synthetic documents, and enables log-linear improvements as both synthetic data volume and generator strength increase, which enables the model to outperform RAG by a 2.6% relative gain on QuaLITY, a long-document reading comprehension benchmark.
