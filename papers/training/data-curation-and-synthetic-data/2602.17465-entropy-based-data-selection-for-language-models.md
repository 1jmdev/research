...
**arXiv:** [2602.17465](https://arxiv.org/abs/2602.17465) · [PDF](https://arxiv.org/pdf/2602.17465) · [HTML](https://arxiv.org/html/2602.17465) · **First submitted:** 2026-02-19  
**Category:** [Data curation, mixtures & synthetic data](README.md) — **rank #224 of 247** by impact score  

> **TL;DR** — Entropy-Based Unsupervised Data Selection (EUDS) framework provides an innovative solution for the efficient fine-tuning of LMs in the compute-constrained scenarios and significantly reduces computational costs and improves training time efficiency with less data requirement.
...
| Venue | IEEE Access |
| arXiv comments | IEEE Access, 15 pages, 5 figures, 11 tables |
...
```sh
arxiv read 2602.17465            # full paper as Markdown (github.com/1jmdev/arxiv)
arxiv section 2602.17465 "method"
arxiv bibtex 2602.17465
```
