...
**Category:** [Data curation, mixtures & synthetic data](README.md) — **rank #192 of 247** by impact score  

> **TL;DR** — A reinforcement learning primitive, the Dataset Policy Gradient (DPG), which can precisely optimize synthetic data generators to produce a dataset of targeted examples to suggest that DPG is a powerful and flexible technique for shaping model properties using only synthetic training examples.
