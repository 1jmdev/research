...
**Category:** [Data curation, mixtures & synthetic data](README.md) — **rank #68 of 247** by impact score  

> **TL;DR** — A flexible and efficient data mixing framework, Chameleon, that employs leverage scores to quantify domain importance within a learned embedding space that enables efficient domain reweighting in finetuning.
