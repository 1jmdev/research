...
**arXiv:** [2609.10445](https://arxiv.org/abs/2609.10445) · [PDF](https://arxiv.org/pdf/2609.10445) · [HTML](https://arxiv.org/html/2609.10445) · **First submitted:** 2026-09-09  
**Category:** [Data curation, mixtures & synthetic data](README.md) — **rank #45 of 240** by impact score  

> **TL;DR** — Optimized supervised fine-tuning data composition enables reasoning models to consistently process and respond in diverse non-English languages without requiring reasoning supervision in each target language.
...
- Building Tiny Aya L2-Thinker at 3.35B scale, we achieve an L2 reasoning rate above 93% across 60 languages on 6 benchmarks spanning math, commonsense reasoning, instruction following, open-ended generation, and cultural reasoning while keeping performance strong.
...
**Keywords:** reasoning language models, L2 reasoning, supervised fine-tuning, SFT, reasoning generalization, multilingual reasoning, data scheduling, data composition

## Reproduce / read

```sh
arxiv read 2609.10445            # full paper as Markdown (github.com/1jmdev/arxiv)
arxiv section 2609.10445 "method"
arxiv bibtex 2609.10445
```
