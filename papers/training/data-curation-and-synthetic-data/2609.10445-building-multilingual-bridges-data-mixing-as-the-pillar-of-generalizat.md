...
**Category:** [Data curation, mixtures & synthetic data](README.md) — **rank #98 of 247** by impact score  

> **TL;DR** — It is shown the path to generalizing L2 reasoning to held-out languages goes through broader language coverage, readily available multilingual non-reasoning data, and a sufficient English reasoning backbone, indicating that reasoning is a language-agnostic behavior that can be transferred across typologically diverse languages through careful data mixing.
