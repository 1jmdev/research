...
**Category:** [Data curation, mixtures & synthetic data](README.md) — **rank #157 of 247** by impact score  

> **TL;DR** — It is proved that SAEs can serve as a good alternative to diversity measure and design the method to be scalable for potential industrial large-scale pruning, and it is experimentally proved that models trained on the selected data can outperform other methods in terms of model capabilities, reduce training cost, and potentially gain more control over model behaviors.
