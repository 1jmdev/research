...
**Category:** [Data curation, mixtures & synthetic data](README.md) — **rank #147 of 247** by impact score  
**Also relevant to:** [Scaling laws](../scaling-laws/README.md)  

> **TL;DR** — It is shown that under certain conditions, small curated datasets can outperform full datasets, and the framework provides analytical conditions for this by deriving precise phase transition curves tied to data size and quality.
