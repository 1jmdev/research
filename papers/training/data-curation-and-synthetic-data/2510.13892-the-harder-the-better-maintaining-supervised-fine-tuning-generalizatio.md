...
**Category:** [Data curation, mixtures & synthetic data](README.md) — **rank #199 of 247** by impact score  

> **TL;DR** — THTB prioritizes higher-level cognitive instructions by combining quality filtering with intrinsic and extrinsic hardness scoring, offering interpretable and quantifiable criteria for efficient SFT, both in data selection and annotation guidance.
