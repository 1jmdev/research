...
**Category:** [Data curation, mixtures & synthetic data](README.md) — **rank #189 of 247** by impact score  

> **TL;DR** — It is found that beyond the widely recognized importance of prompt-response quality, prompt difficulty itself plays a critical role in driving alignment gains, and PiKa is introduced, a data-efficient family of expert-level alignment datasets that concentrates supervision on high-difficulty instructions.
