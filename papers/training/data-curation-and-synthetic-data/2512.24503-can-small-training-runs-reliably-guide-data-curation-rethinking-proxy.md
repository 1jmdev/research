...
**Category:** [Data curation, mixtures & synthetic data](README.md) — **rank #127 of 247** by impact score  

> **TL;DR** — This work uncovers a subtle yet critical issue in the standard experimental protocol for data recipe assessment: the use of identical small-scale model training configurations across all data recipes in the name of "fair" comparison, and introduces a simple patch to the evaluation protocol: using reduced learning rates for proxy model training.
