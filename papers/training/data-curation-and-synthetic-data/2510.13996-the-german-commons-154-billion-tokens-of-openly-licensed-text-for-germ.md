...
**Category:** [Data curation, mixtures & synthetic data](README.md) — **rank #92 of 247** by impact score  

> **TL;DR** — The German Commons is introduced, the largest collection of openly licensed German text to date, that compiles data from 41 sources across seven domains, encompassing legal, scientific, cultural, political, news, economic, and web text, and enables the development of truly open German language models.
