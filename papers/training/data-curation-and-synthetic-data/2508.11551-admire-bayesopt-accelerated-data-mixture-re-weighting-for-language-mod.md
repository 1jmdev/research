...
**Category:** [Data curation, mixtures & synthetic data](README.md) — **rank #181 of 247** by impact score  

> **TL;DR** — This work proposes to view the selection of training data mixtures as a black-box hyperparameter optimization problem, for which Bayesian Optimization is a well-established class of appropriate algorithms, and introduces a natural framework to balance experiment cost with model fit.
