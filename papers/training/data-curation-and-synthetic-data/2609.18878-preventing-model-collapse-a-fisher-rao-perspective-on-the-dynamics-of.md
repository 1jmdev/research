...
**Category:** [Data curation, mixtures & synthetic data](README.md) — **rank #246 of 247** by impact score  

> **TL;DR** — It is shown that the effective required data ratio to prevent model collapse is different than previously implied, and quantitative contraction and invariance bounds that are stable and do not become trivial as the dimensions increase are derived.
