...
**Category:** [Data curation, mixtures & synthetic data](README.md) — **rank #51 of 247** by impact score  
**Also relevant to:** [Pre-training recipes & efficiency](../pretraining-recipes-and-efficiency/README.md)  

> **TL;DR** — The detailed provenance of data assembling and the details of dataset filtering and curation are presented and it is found that two small language models trained on Common Corpus perform comparably to other models of their size, indicating that the dataset is suitable for multilingual pretraining.
