...
**Category:** [Data curation, mixtures & synthetic data](README.md) — **rank #215 of 247** by impact score  
**Also relevant to:** [Pre-training recipes & efficiency](../pretraining-recipes-and-efficiency/README.md)  

> **TL;DR** — This work proposes MixMinMatch, a method that combines multiple existing web corpora, performs cross-dataset MinHash deduplication, and identifies documents independently recovered by multiple sources, producing corpora that match or exceed the quality of the best single-source baselines.
