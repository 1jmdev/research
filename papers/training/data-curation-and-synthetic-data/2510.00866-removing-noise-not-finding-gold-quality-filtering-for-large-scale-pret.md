...
**Category:** [Data curation, mixtures & synthetic data](README.md) — **rank #134 of 247** by impact score  
**Also relevant to:** [Pre-training recipes & efficiency](../pretraining-recipes-and-efficiency/README.md)  

> **TL;DR** — It is found that training on CQF-selected data can outperform training directly on the high-quality set, even when the latter is sufficiently large, which is particularly striking given the substantial effort and cost recently devoted to augmenting high-quality data.
