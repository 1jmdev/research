...
**arXiv:** [2508.15096](https://arxiv.org/abs/2508.15096) · [PDF](https://arxiv.org/pdf/2508.15096) · [HTML](https://arxiv.org/html/2508.15096) · **First submitted:** 2025-08-20  
**Category:** [Data curation, mixtures & synthetic data](README.md) — **rank #66 of 247** by impact score  
**Also relevant to:** [Pre-training recipes & efficiency](../pretraining-recipes-and-efficiency/README.md)  

> **TL;DR** — This work introduces Nemotron-CC-Math, a large-scale, high-quality mathematical corpus constructed from Common Crawl using a novel, domain-agnostic pipeline specifically designed for robust scientific text extraction, and presents the first pipeline to reliably extract scientific content--including math--from noisy web-scale data.
...
| Models used | Nemotron-CC-Math, Nemotron-CC-Math-3, Nemotron-CC-Math-4, Nemotron-T |
| Impact score | 5.35 |

## Key results (claimed in abstract)

- Notably, Nemotron-CC-Math-4+ not only surpasses all prior open math datasets-including MegaMath, FineMath, and OpenWebMath-but also contains 5.5 times more tokens than FineMath-4+, which was previously the highest-quality math pretraining dataset.
...
```sh
arxiv read 2508.15096            # full paper as Markdown (github.com/1jmdev/arxiv)
arxiv section 2508.15096 "method"
arxiv bibtex 2508.15096
```
