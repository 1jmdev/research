...
**Category:** [Tokenization & byte-level models](README.md) — **rank #46 of 90** by impact score  
**Also relevant to:** [Scaling laws](../scaling-laws/README.md)  

> **TL;DR** — The experiments reveal that in compute-optimal configurations, model parameter counts scale proportionally to data size measured in bytes, not in tokens as commonly perceived (Kaplan et al., 2020; Hoffmann et al., 2022).
