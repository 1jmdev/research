...
> **TL;DR** — This work proposes a compact reshaping of the vocabulary: instead of assigning unique tokens to each surface form, they compose them from shared base form and transformation vectors, freeing 10-40% of vocabulary slots to be reallocated where tokenization is inefficient.
