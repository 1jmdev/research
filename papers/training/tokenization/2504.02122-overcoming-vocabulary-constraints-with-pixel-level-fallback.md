...
**Category:** [Tokenization & byte-level models](README.md) — **rank #32 of 90** by impact score  

> **TL;DR** — This work proposes to augment pretrained language models with a vocabulary-free encoder that generates input embeddings from text rendered as pixels that substantially improves machine translation performance and facilitates effective cross-lingual transfer, outperforming tokenizer-based methods.
