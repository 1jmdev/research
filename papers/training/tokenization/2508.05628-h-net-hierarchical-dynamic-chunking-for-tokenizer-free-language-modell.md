...
**Category:** [Tokenization & byte-level models](README.md) — **rank #76 of 90** by impact score  

> **TL;DR** — H-NET++ is proposed, a hierarchical dynamic-chunking model that learns linguistically-informed segmentation through end-to-end training that aligns with Persian morphology without explicit supervision, demonstrating that hierarchical dynamic chunking provides an effective tokenizer-free solution for MRLs while maintaining computational efficiency.
