...
**Category:** [Tokenization & byte-level models](README.md) — **rank #35 of 90** by impact score  

> **TL;DR** — This paper formalizes tokenization using monoid theory and proves that tokenizers whose vocabularies contain tokens that are ill-formed UTF-8 can always produce sequences that are ill-formed UTF-8.
