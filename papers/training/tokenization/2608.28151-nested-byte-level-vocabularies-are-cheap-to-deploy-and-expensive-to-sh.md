...
**Category:** [Tokenization & byte-level models](README.md) — **rank #72 of 90** by impact score  

> **TL;DR** — Slicing a byte-level BPE tokenizer allows one language model to operate at several vocabulary sizes, use a control token to indicate the active size, and be deployed at any trained size by slicing its embedding and output head, yielding a falsifiable prediction for future work.
