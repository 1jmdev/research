...
**Category:** [Scaling laws](README.md) — **rank #81 of 87** by impact score  

> **TL;DR** — A FLOP-accounting framework for GRPO post-training is introduced that decomposes compute into rollout/search, policy-update/learning, and reward- or feedback-model evaluation, and the results suggest that RL post-training papers should report total FLOPs together with how compute is divided among model size, search, learning, and feedback.
