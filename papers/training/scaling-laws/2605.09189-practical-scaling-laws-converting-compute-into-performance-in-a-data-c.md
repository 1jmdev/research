...
**arXiv:** [2605.09189](https://arxiv.org/abs/2605.09189) · [PDF](https://arxiv.org/pdf/2605.09189) · [HTML](https://arxiv.org/html/2605.09189) · **First submitted:** 2026-09-21  
**Category:** [Scaling laws](README.md) — **rank #77 of 87** by impact score  

> **TL;DR** — A closed-form extension of Chinchilla's scaling law form, which decomposes loss into undercapacity, undertraining, and overfitting terms, achieves state-of-the-art RMSE on every published LLM grid the authors evaluate and on most cells of their constructed experiments.
...
```sh
arxiv read 2605.09189            # full paper as Markdown (github.com/1jmdev/arxiv)
arxiv section 2605.09189 "method"
arxiv bibtex 2605.09189
```
