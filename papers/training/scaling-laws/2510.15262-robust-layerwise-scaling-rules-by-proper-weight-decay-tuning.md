...
**Category:** [Scaling laws](README.md) — **rank #22 of 87** by impact score  

> **TL;DR** — The results extend $\mu$P beyond the near-init regime by explicitly controlling steady-state scales set by the optimizer, offering a practical recipe for width-robust hyperparameter transfer under AdamW.
