...
**Category:** [Scaling laws](README.md) — **rank #44 of 87** by impact score  

> **TL;DR** — The first large-scale empirical study of scaling laws for code is conducted, comprising 117 experimental runs with model sizes from 0.2B to 3.8B and training tokens, and shows that the more expressive Farseer law offers greater accuracy and that Code LLMs scale effectively with model size.
