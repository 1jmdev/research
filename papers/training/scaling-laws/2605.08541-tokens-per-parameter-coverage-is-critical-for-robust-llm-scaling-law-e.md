...
**Category:** [Scaling laws](README.md) — **rank #76 of 87** by impact score  

> **TL;DR** — It is shown that the degeneracy is rooted in Jacobian geometry and is not an artifact of the loss function: any smooth estimation objective whose curvature involves the Jacobian inherits the same ill-conditioning in the Gauss-Newton least-squares problem.
