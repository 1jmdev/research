...
**Category:** [Scaling laws](README.md) — **rank #8 of 88** by impact score  
...
> **TL;DR** — As N and D scale, optimal $\tau$ obeys a precise power law in the tokens-per-parameter ratio, D/N, which provides a method to accurately predict $\lambda$opt in advance of large-scale training.
...
| Citations (Semantic Scholar, 2026-09-25) | 41 (12 influential) |
