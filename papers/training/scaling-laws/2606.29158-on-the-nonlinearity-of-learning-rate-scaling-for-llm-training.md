...
**Category:** [Scaling laws](README.md) — **rank #51 of 87** by impact score  

> **TL;DR** — It is found that the optimal learning rate develops upward curvature at larger scales, leading to inaccurate extrapolation, and this curvature largely disappears when learning rates are replaced by effective learning rate, and when data $D$ extrapolation is used instead of model size $N$ extrapolation.
