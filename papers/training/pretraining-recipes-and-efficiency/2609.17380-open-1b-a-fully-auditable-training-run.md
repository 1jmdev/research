...
**Category:** [Pre-training recipes & efficiency](README.md) — **rank #139 of 143** by impact score  

> **TL;DR** — Open-1B, a model trained under this regime, is released, together with its full pretraining dataset, every intermediate checkpoint, the training codebase, and the audit harness needed to reproduce and verify any step of its training.
