...
**Category:** [Pre-training recipes & efficiency](README.md) — **rank #37 of 135** by impact score  

> **TL;DR** — Neural cellular automata generate synthetic spatiotemporal data for pre-pre-training large language models, achieving better performance and faster convergence than traditional natural language pre-training.
