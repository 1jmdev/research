...
**Category:** [Pre-training recipes & efficiency](README.md) — **rank #110 of 143** by impact score  

> **TL;DR** — It is discovered that using DiLoCo-pretrained weights and running mid- and post-training with DDP fails to recover performance, revealing irreversible representation drift from asynchronous updates that impairs downstream alignment.
