...
**Category:** [Pre-training recipes & efficiency](README.md) — **rank #57 of 143** by impact score  
...
> **TL;DR** — This work presents SuperOffload, a Superchip-centric offloading system that simultaneously uses Hopper GPU, Grace CPU, and NVLink-C2C interconnect more efficiently and extends SuperOffload with ZeRO-style data parallelism and DeepSpeed-Ulysses sequence parallelism.
