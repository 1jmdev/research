...
**Category:** [Pre-training recipes & efficiency](README.md) — **rank #86 of 143** by impact score  
...
> **TL;DR** — The Nexus optimizer is proposed, which encourages the closeness of task-specific minima by maximizing gradient similarity during optimization, and challenges the reliance on pretraining loss as the sole proxy for model evaluation and demonstrates the importance of implicit biases in unlocking downstream generalization.
