...
**Category:** [Pre-training recipes & efficiency](README.md) — **rank #120 of 143** by impact score  
**Also relevant to:** [Visual token pruning / merging for VLMs](../../context-compression/visual-token-reduction/README.md)  

> **TL;DR** — This work proposes a training-efficient framework based on sparse representations, termed the Sparse Training Scheme (STS), which adopts a stage-aware design that adapts to different sources of redundancy during training and is broadly applicable to diverse MLLM architectures.
