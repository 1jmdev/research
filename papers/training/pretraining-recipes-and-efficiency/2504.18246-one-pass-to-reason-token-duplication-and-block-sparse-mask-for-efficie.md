...
**Category:** [Pre-training recipes & efficiency](README.md) — **rank #105 of 143** by impact score  

> **TL;DR** — This work proposes duplicating response tokens along with a custom attention mask to enable single-pass processing of entire conversations to reduce time complexity while reducing time complexity for a transformer based model.
