...
**Category:** [Pre-training recipes & efficiency](README.md) — **rank #142 of 143** by impact score  

> **TL;DR** — Results show that selective anti-interference is an effective objective-level signal for robust context use and identifies locally sufficient tokens and sharply reduces prefix sensitivity on gate-selected suffix tokens.
