...
**Category:** [Parameter-efficient fine-tuning (LoRA & friends)](README.md) — **rank #90 of 117** by impact score  

> **TL;DR** — SGC can deliver superior performance while substantially lowering optimizer state memory requirements, particularly in both data-limited and memory-limited settings, and is demonstrated to offer a flexible tradeoff between memory efficiency and performance.
