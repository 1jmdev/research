...
**Category:** [Parameter-efficient fine-tuning (LoRA & friends)](README.md) — **rank #79 of 117** by impact score  

> **TL;DR** — HullFT is introduced, a geometric approach to TTFT that addresses both bottlenecks and improves the quality-efficiency tradeoff over current state-of-the-art TTFT methods, achieving lower bits-per-byte at substantially lower total runtime.
