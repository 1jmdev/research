...
**arXiv:** [2501.15103](https://arxiv.org/abs/2501.15103) · [PDF](https://arxiv.org/pdf/2501.15103) · [HTML](https://arxiv.org/html/2501.15103) · **First submitted:** 2025-06-19  
**Category:** [Parameter-efficient fine-tuning (LoRA & friends)](README.md) — **rank #27 of 115** by impact score  
**Also relevant to:** [MoE architecture & routing](../../mixture-of-experts/architecture-and-routing/README.md)  

> **TL;DR** — This paper demonstrates that the dynamic routing of multiple LoRAs is functionally equivalent to rank partitioning and block-level activation within a single LoRA, and proposes Single-ranked Mixture of Experts LoRA, which embeds MoE into LoRA by treating each rank as an independent expert.

## At a glance

| Field | Value |
| --- | --- |
| Authors | Ziyu Zhao, Yixiao Zhou, Zhi Zhang, Didi Zhu, Tao Shen, Zexi Li, Jinluan Yang, Xuwu Wang, Jing Su, Kun Kuang, … (+3) |
...
```sh
arxiv read 2501.15103            # full paper as Markdown (github.com/1jmdev/arxiv)
arxiv section 2501.15103 "method"
arxiv bibtex 2501.15103
```
