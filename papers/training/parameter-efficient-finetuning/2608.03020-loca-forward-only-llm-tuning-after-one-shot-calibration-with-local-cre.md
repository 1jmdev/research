...
**arXiv:** [2608.03020](https://arxiv.org/abs/2608.03020) · [PDF](https://arxiv.org/pdf/2608.03020) · [HTML](https://arxiv.org/html/2608.03020) · **First submitted:** 2026-08-07  
**Category:** [Parameter-efficient fine-tuning (LoRA & friends)](README.md) — **rank #98 of 117** by impact score  

> **TL;DR** — Local Credit Assignment (LoCA), a two-stage method for small-shift adaptation, is introduced, a two-stage method for small-shift adaptation that amortizes global credit assignment into one calibration and enables later forward-only tuning when repeated backpropagation is impractical.
...
| Code | https://github.com/Xia12121/LoCA |
| Models used | Qwen2.5 |
| Impact score | 0.5 |

## Key results (claimed in abstract)

- After calibration, its CPU steady-state memory is 36--52\% lower and its per-pass time is 43--48\% lower.
...
```sh
arxiv read 2608.03020            # full paper as Markdown (github.com/1jmdev/arxiv)
arxiv section 2608.03020 "method"
arxiv bibtex 2608.03020
```
