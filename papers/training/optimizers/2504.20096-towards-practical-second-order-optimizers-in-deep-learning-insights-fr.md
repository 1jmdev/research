...
**Category:** [Optimizers & training dynamics (Muon, AdamW, schedules)](README.md) — **rank #89 of 158** by impact score  

> **TL;DR** — AdaFisher is a novel adaptive second-order optimizer that leverages a diagonal block-Kronecker approximation of the Fisher information matrix to adaptively precondition gradients and outperforms state-of-the-art optimizers in both accuracy and convergence speed.
