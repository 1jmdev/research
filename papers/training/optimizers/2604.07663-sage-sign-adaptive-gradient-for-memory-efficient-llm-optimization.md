...
**Category:** [Optimizers & training dynamics (Muon, AdamW, schedules)](README.md) — **rank #106 of 158** by impact score  

> **TL;DR** — This work identifies the embedding layer dilemma: these methods fail to handle the sparse, high-variance gradients inherent to embeddings, forcing a hybrid design that reverts to AdamW and partially negates the memory gains, and proposes SAGE (Sign Adaptive GradiEnt), a novel optimizer that resolves this dilemma.
