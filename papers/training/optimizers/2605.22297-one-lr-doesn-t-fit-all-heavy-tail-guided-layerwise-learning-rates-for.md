...
**Category:** [Optimizers & training dynamics (Muon, AdamW, schedules)](README.md) — **rank #79 of 158** by impact score  

> **TL;DR** — Layerwise Learning Rate is introduced, an adaptive scheme that assigns distinct learning rates to individual Transformer layers that improves the average zero-shot accuracy of 1B models and that of 3B models from 48.58% to 50.61%.
