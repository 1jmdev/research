...
**Category:** [Optimizers & training dynamics (Muon, AdamW, schedules)](README.md) — **rank #103 of 158** by impact score  

> **TL;DR** — This work presents ADANA, an AdamW-like optimizer that couples log-time schedules with explicit damping to balance stability and performance, and empirically evaluates ADANA across transformer scalings, comparing against AdamW, Muon, and AdEMAMix.
