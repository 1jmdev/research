...
**Category:** [Optimizers & training dynamics (Muon, AdamW, schedules)](README.md) — **rank #91 of 158** by impact score  
**Also relevant to:** [Pre-training recipes & efficiency](../pretraining-recipes-and-efficiency/README.md)  

> **TL;DR** — It is proved that such imbalance tightens the second-order term in a blockwise descent analysis, weakening Muon's per-step descent guarantee, and proposed Muon+, a one-line fix that inserts a single normalization step after polar orthogonalization, adds no optimizer state.
