...
**Category:** [Optimizers & training dynamics (Muon, AdamW, schedules)](README.md) — **rank #153 of 158** by impact score  

> **TL;DR** — This work proposes WSqD (Warmup with Square-root base and linear Decay), a learning rate schedule that replaces WSD's constant stable phase with a shifted inverse-square-root base while retaining the final linear cooldown, and provably attains the minimax-optimal last-iterate convergence rate in the stochastic convex setting.
