...
**arXiv:** [2512.05620](https://arxiv.org/abs/2512.05620) · [PDF](https://arxiv.org/pdf/2512.05620) · [HTML](https://arxiv.org/html/2512.05620) · **First submitted:** 2026-01-18  
**Category:** [Optimizers & training dynamics (Muon, AdamW, schedules)](README.md) — **rank #28 of 158** by impact score  

> **TL;DR** — This work investigates how to scale preconditioned optimizers via hyperparameter transfer, and argues that studying optimal hyperparameter transfer is essential for reliably comparing optimizers at scale given a realistic tuning budget.
...
| Venue | NeurIPS 2025 |
| arXiv comments | NeurIPS 2025. Code available at: https://github.com/charliezchen/scaling-matrix-preconditioning |
| Citations (Semantic Scholar, 2026-09-25) | 15 (2 influential) |
| Hugging Face upvotes | 0 |
| Code | https://github.com/charliezchen/scaling-matrix-preconditioning |
| Models used | Llama- |
| Impact score | 5.4 |

## Key results (claimed in abstract)

- Applying these scaling rules, we show Muon, SOAP and Shampoo consistently achieve near $1.4\times$ speedup over AdamW for training Llama-architecture language models of sizes ranging from $190$M to $1.4$B, whereas the speedup vanishes rapidly with scale under incorrect scaling.
...
```sh
arxiv read 2512.05620            # full paper as Markdown (github.com/1jmdev/arxiv)
arxiv section 2512.05620 "method"
arxiv bibtex 2512.05620
```
