...
**Category:** [Optimizers & training dynamics (Muon, AdamW, schedules)](README.md) — **rank #117 of 158** by impact score  

> **TL;DR** — It is suggested that controlling the changes to logits is important for stability, and it is shown that these changes are controllable by assigning parameter-dependent learning rates to the query and key weights.
