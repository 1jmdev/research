...
**Category:** [Optimizers & training dynamics (Muon, AdamW, schedules)](README.md) — **rank #102 of 158** by impact score  

> **TL;DR** — Spectral-Aware Muon is introduced, which holds the head at the Muon scale and amplifies the bulk using a static spectral prior, and both variants outperform tuned AdamW and Muon (Scion implementation) baselines in all evaluated model-scale and batch-size configurations.
