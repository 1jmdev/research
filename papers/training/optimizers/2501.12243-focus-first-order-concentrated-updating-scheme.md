...
**Category:** [Optimizers & training dynamics (Muon, AdamW, schedules)](README.md) — **rank #113 of 158** by impact score  

> **TL;DR** — This work develops FOCUS, an optimizer that enhances Signum by incorporating attraction toward moving averaged parameters, allowing it to handle noise better while maintaining larger step sizes, and suggests that gradient noise may be an underappreciated limiting factor in LLM training.
