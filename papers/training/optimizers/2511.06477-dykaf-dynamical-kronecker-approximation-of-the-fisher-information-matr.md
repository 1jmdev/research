...
**Category:** [Optimizers & training dynamics (Muon, AdamW, schedules)](README.md) — **rank #137 of 158** by impact score  

> **TL;DR** — This work introduces a novel approach that leverages projector-splitting integrators to construct effective preconditioners, DyKAF (Dynamical Kronecker Approximation of the Fisher Matrix), which consistently improves the Fisher matrix approximation quality.
