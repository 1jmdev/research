...
**Category:** [Reinforcement learning for LLM reasoning (GRPO, RLVR)](README.md) — **rank #235 of 514** by impact score  

> **TL;DR** — A theoretical analysis of GRPO's learning dynamic is provided, identifying the source of LLD as the naive penalization of all tokens in incorrect responses with the same strength, and developing a method called NTHR, which downweights penalties on tokens contributing to the LLD.
