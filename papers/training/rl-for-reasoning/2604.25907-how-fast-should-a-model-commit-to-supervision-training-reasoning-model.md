...
**Category:** [Reinforcement learning for LLM reasoning (GRPO, RLVR)](README.md) — **rank #416 of 516** by impact score  

> **TL;DR** — This separation explains how SFT first moves the model out of the cold-start regime, followed by the more robust RLVR, under the SFT-then-RLVR paradigm.
