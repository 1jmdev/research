...
**Category:** [Reinforcement learning for LLM reasoning (GRPO, RLVR)](README.md) — **rank #235 of 516** by impact score  

> **TL;DR** — This work introduces Difficulty Adaptive Rollout Sampling (DARS), a method that re-weights difficult problems by using targeted, multi-stage rollouts and demonstrates simultaneous gains in both Pass@K and Pass@1, confirming that depth and breadth are orthogonal and complementary dimensions for unlocking the full power of RLVR.
