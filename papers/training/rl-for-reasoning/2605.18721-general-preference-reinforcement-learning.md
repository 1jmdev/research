...
**Category:** [Reinforcement learning for LLM reasoning (GRPO, RLVR)](README.md) — **rank #486 of 514** by impact score  

> **TL;DR** — The General Preference Model (GPM), which embeds responses into skew-symmetric subspaces and represents preference as a structured, intransitivity-aware comparison, is proposed, and General Preference Reinforcement Learning (GPRL), which carries the $k$-way structure through to the policy update.
