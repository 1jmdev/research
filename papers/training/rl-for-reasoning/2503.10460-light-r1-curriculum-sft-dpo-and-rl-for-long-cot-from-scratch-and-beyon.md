...
**Category:** [Reinforcement learning for LLM reasoning (GRPO, RLVR)](README.md) — **rank #36 of 514** by impact score  

> **TL;DR** — This paper introduces Light-R1, an open-source suite for training long reasoning models using reproducible and cost-effective methodology, and extends the work by applying GRPO on long reasoning models.
...
| Citations (Semantic Scholar, 2026-09-25) | 193 (14 influential) |
