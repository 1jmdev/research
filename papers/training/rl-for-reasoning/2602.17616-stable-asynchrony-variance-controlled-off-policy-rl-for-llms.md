...
**Category:** [Reinforcement learning for LLM reasoning (GRPO, RLVR)](README.md) — **rank #329 of 514** by impact score  

> **TL;DR** — VCPO is introduced, a method that dynamically scales the learning rate with ESS to dampen unreliable updates and applies a closed-form minimum-variance baseline for off-policy settings, without a critic model and adding minimal overhead, and enables robustly stable asynchronous training compared to previous stabilization and algorithmic methods.
