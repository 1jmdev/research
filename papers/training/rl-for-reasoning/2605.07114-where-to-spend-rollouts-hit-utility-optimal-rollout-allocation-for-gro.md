...
**Category:** [Reinforcement learning for LLM reasoning (GRPO, RLVR)](README.md) — **rank #438 of 516** by impact score  

> **TL;DR** — HORA is proposed, a learning-free rollout allocation policy that maximizes total posterior hit utility within each allocation batch, and is competitive with five prompt-conditioned learned-prior alternatives.
