...
**Category:** [Reinforcement learning for LLM reasoning (GRPO, RLVR)](README.md) — **rank #281 of 516** by impact score  

> **TL;DR** — It is proved that decoupling is impossible in either order: SFT-then-RL coupling: RL increases SFT loss under both distributional and landscape analyses, and RL-then-SFT coupling: SFT lowers the reward achieved by RL under analogous conditions.
