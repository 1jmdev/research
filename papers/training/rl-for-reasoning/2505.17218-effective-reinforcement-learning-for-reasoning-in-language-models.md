...
**Category:** [Reinforcement learning for LLM reasoning (GRPO, RLVR)](README.md) — **rank #442 of 516** by impact score  

> **TL;DR** — It is found that a key bottleneck to computational efficiency is that the optimal batch sizes for inference and backpropagation are different, and a novel algorithm is proposed, DASH, that performs preemptive sampling, and gradient filtering, and reduces training time by 83% compared to a standard implementation of GRPO without sacrificing accuracy.
