...
**arXiv:** [2607.22186](https://arxiv.org/abs/2607.22186) · [PDF](https://arxiv.org/pdf/2607.22186) · [HTML](https://arxiv.org/html/2607.22186) · **First submitted:** 2026-08-03  
**Category:** [Reinforcement learning for LLM reasoning (GRPO, RLVR)](README.md) — **rank #393 of 514** by impact score  

> **TL;DR** — The Entropy-Scaled Trust Region (ESTR), which scales each token's off-policy deviation by its local entropy, requiring no auxiliary forward passes or explicit version-switch detection, consistently outperforms existing asynchronous methods and achieves the best train-inference consistency.
...
- It reaches $37.34$ avg@1 on BrowseComp-Plus and $95.69$ on multi-turn GSM8K, matching synchronous GRPO while achieving a $2.6\times$ speedup.
...
```sh
arxiv read 2607.22186            # full paper as Markdown (github.com/1jmdev/arxiv)
arxiv section 2607.22186 "method"
arxiv bibtex 2607.22186
```
