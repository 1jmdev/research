...
**Category:** [Reinforcement learning for LLM reasoning (GRPO, RLVR)](README.md) — **rank #297 of 516** by impact score  
**Also relevant to:** [Optimizers & training dynamics (Muon, AdamW, schedules)](../optimizers/README.md)  

> **TL;DR** — A theory of the training dynamics of RLVR for transformers on compositional reasoning tasks shows that mixed-difficulty training naturally induces an implicit curriculum, where easier problems become learnable first and shape the frontier for harder ones, creating a learning progression from easy to hard during optimization.
