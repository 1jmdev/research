...
**Category:** [Reinforcement learning for LLM reasoning (GRPO, RLVR)](README.md) — **rank #252 of 514** by impact score  

> **TL;DR** — PipelineRL is introduced, an approach designed to achieve a superior trade-off between hardware efficiency and data on-policyness for LLM training, distinguished by the novel in-flight weight updates.
