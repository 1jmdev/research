...
**Category:** [Reinforcement learning for LLM reasoning (GRPO, RLVR)](README.md) — **rank #356 of 516** by impact score  

> **TL;DR** — Self-improvement can self-regress, and in REINFORCE post-training for code, a model can quickly improve on its optimized metric and then collapse within the same training campaign, suggesting the phenomenon is not limited to Qwen.
