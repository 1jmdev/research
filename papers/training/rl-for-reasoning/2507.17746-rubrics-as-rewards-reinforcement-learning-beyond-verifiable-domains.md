...
**Category:** [Reinforcement learning for LLM reasoning (GRPO, RLVR)](README.md) — **rank #66 of 516** by impact score  

> **TL;DR** — RaR is introduced, an on-policy reinforcement learning method that extends RLVR beyond verifiable domains by using rubric-based feedback by using rubrics as structured reward signals, and is found that using rubrics as structured reward signals yields better alignment for smaller judges and reduces performance variance across judge scales.
...
| Citations (Semantic Scholar, 2026-09-25) | 311 (48 influential) |
