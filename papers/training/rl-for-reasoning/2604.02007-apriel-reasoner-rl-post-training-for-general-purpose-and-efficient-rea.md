...
**Category:** [Reinforcement learning for LLM reasoning (GRPO, RLVR)](README.md) — **rank #333 of 516** by impact score  
...
> **TL;DR** — This work presents Apriel-Reasoner, a reproducible multi-domain RL post-training recipe that improves the accuracy-token tradeoff using a fully public-data recipe and introduces adaptive domain sampling that preserves target completed-rollout ratios despite heterogeneous rollout dynamics.
