...
**Category:** [Reinforcement learning for LLM reasoning (GRPO, RLVR)](README.md) — **rank #404 of 516** by impact score  

> **TL;DR** — An impossibility theorem is established: under the standard outcome reward + GRPO setting, no length-based weighting scheme can simultaneously achieve the following two properties: gradient unbiasedness and length invariance.
