...
**Category:** [Reinforcement learning for LLM reasoning (GRPO, RLVR)](README.md) — **rank #394 of 514** by impact score  

> **TL;DR** — A comprehensive trajectory-level analysis of RLVR is performed and reveals a striking regularity: across various model families, RL algorithms, and training configurations, RLVR consistently enters a robust linear regime, where both parameter weights and output log-probabilities evolve in a highly linear manner.
