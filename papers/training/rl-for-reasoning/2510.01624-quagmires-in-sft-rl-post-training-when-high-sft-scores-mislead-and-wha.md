...
**Category:** [Reinforcement learning for LLM reasoning (GRPO, RLVR)](README.md) — **rank #267 of 514** by impact score  

> **TL;DR** — This work challenges whether high SFT scores translate to improved performance after RL, and studies alternative metrics and identifies generalization loss on held-out reasoning examples and Pass@large k performance to provide strong proxies for the RL outcome.
