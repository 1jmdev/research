...
**arXiv:** [2609.13058](https://arxiv.org/abs/2609.13058) · [PDF](https://arxiv.org/pdf/2609.13058) · [HTML](https://arxiv.org/html/2609.13058) · **First submitted:** 2026-09-11  
**Category:** [Reinforcement learning for LLM reasoning (GRPO, RLVR)](README.md) — **rank #209 of 501** by impact score  

> **TL;DR** — ESRL is introduced, an architecture-aware framework that explicitly explores the expert-routing space of MoE models, and preserves high-confidence experts as anchors, and restricts stochastic routing to a plausible candidate pool, thereby retaining reliable computation paths.
...
| Code | https://github.com/strawberrymaster111/ESRL-Release |
...
**Keywords:** Mixture-of-Experts, expert routing, rollout diversity, Expert-Space Exploration Reinforcement Learning, router entropy, path replay, GRPO

## Reproduce / read

```sh
arxiv read 2609.13058            # full paper as Markdown (github.com/1jmdev/arxiv)
arxiv section 2609.13058 "method"
arxiv bibtex 2609.13058
```
