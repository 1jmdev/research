...
**Category:** [Reinforcement learning for LLM reasoning (GRPO, RLVR)](README.md) — **rank #126 of 514** by impact score  

> **TL;DR** — The benefits of long CoT for general-purpose chat capabilities are established and RL with Model-rewarded Thinking (RLMT)1 is introduced, which pushes RLVR beyond verifiable domains.
