...
**arXiv:** [2504.12501](https://arxiv.org/abs/2504.12501) · [PDF](https://arxiv.org/pdf/2504.12501) · [HTML](https://arxiv.org/html/2504.12501) · **First submitted:** 2026-09-11  
**Category:** [Reinforcement learning for LLM reasoning (GRPO, RLVR)](README.md) — **rank #69 of 516** by impact score  

> **TL;DR** — This book gives a comprehensive introduction to the core methods for post-training models for people with some level of quantitative background, organized around the canonical RLHF recipe.
...
| arXiv comments | 243 pages. Web-native version at https://rlhfbook.com/ Continually improving, latest version at website |
| Citations (Semantic Scholar, 2026-09-25) | 117 (6 influential) |
...
```sh
arxiv read 2504.12501            # full paper as Markdown (github.com/1jmdev/arxiv)
arxiv section 2504.12501 "method"
arxiv bibtex 2504.12501
```
