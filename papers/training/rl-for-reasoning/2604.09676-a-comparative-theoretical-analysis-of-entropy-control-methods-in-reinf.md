...
**Category:** [Reinforcement learning for LLM reasoning (GRPO, RLVR)](README.md) — **rank #481 of 514** by impact score  

> **TL;DR** — A unified framework for entropy dynamics under softmax parameterization is established, showing that entropy change is governed by the covariance between log-probabilities and logit updates.
