...
**Category:** [Reinforcement learning for LLM reasoning (GRPO, RLVR)](README.md) — **rank #351 of 514** by impact score  

> **TL;DR** — This work analyzes RL instability through the lens of optimization, demonstrating that gradient noise and training-inference mismatch escalate in tandem as training progresses, and proposes a simple yet effective solution: a specialized Learning Rate (LR) scheduler.
