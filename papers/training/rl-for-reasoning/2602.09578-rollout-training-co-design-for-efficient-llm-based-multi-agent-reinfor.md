...
**arXiv:** [2602.09578](https://arxiv.org/abs/2602.09578) · [PDF](https://arxiv.org/pdf/2602.09578) · [HTML](https://arxiv.org/html/2602.09578) · **First submitted:** 2026-02-10  
**Category:** [Reinforcement learning for LLM reasoning (GRPO, RLVR)](README.md) — **rank #444 of 516** by impact score  

> **TL;DR** — FlexMARL is the first end-to-end training framework that holistically optimizes rollout, training, and their orchestration for large-scale LLM-based MARL, and introduces the joint orchestrator to manage data flow under the rollout-training disaggregated architecture.

## At a glance

| Field | Value |
| --- | --- |
| Authors | Zhida Jiang, Zhaolong Xing, Jiawei Lu, Yipei Niu, Qingyuan Sang, Liangxu Zhang, Wenquan Dai, Junhua Shu, Jiaxing Wang, Qiangyu Pei, … (+6) |
...
- Empirical results on a large-scale production cluster demonstrate that FlexMARL achieves up to 7.3x speedup and improves hardware utilization by up to 5.6x compared to existing frameworks.
...
```sh
arxiv read 2602.09578            # full paper as Markdown (github.com/1jmdev/arxiv)
arxiv section 2602.09578 "method"
arxiv bibtex 2602.09578
```
