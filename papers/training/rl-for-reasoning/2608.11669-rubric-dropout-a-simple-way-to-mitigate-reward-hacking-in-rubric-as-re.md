...
**arXiv:** [2608.11669](https://arxiv.org/abs/2608.11669) · [PDF](https://arxiv.org/pdf/2608.11669) · [HTML](https://arxiv.org/html/2608.11669) · **First submitted:** 2026-08-12  
**Category:** [Reinforcement learning for LLM reasoning (GRPO, RLVR)](README.md) — **rank #430 of 516** by impact score  

> **TL;DR** — This work proposes Rubric Dropout, a one-line fix borrowed from neuron dropout that randomly drops a subset of the rubric's criteria before computing the reward, so the policy never optimizes the same rubric twice.
...
| arXiv comments | 18 pages, 7 figures, 4 tables. Work in progress |
...
- Comparing no dropout against dropout at 30% and 50% on both benchmark pairs, dropout raises the OOD gold score at every matched checkpoint (+1 to +2 points on HealthBench-Hard, +6 to +7 points on ResearchQA), lowers the two hacking measures we track, and costs nothing in domain.
- Sweeping the dropout fraction shows a broad 30-50% sweet spot, while the natural alternative, reweighting criteria by how useful they are to training, performs worse than no intervention at all in our setting.
...
```sh
arxiv read 2608.11669            # full paper as Markdown (github.com/1jmdev/arxiv)
arxiv section 2608.11669 "method"
arxiv bibtex 2608.11669
```
