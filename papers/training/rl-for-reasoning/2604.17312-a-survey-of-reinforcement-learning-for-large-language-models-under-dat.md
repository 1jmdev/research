...
**Category:** [Reinforcement learning for LLM reasoning (GRPO, RLVR)](README.md) — **rank #450 of 514** by impact score  

> **TL;DR** — This survey presents the first systematic review of reinforcement learning for LLMs under data scarcity, and proposes a bottom-up hierarchical framework built around three complementary perspectives: the data-centric perspective, the training-centric perspective, and the framework-centric perspective.
