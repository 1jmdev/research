...
**Category:** [Reinforcement learning for LLM reasoning (GRPO, RLVR)](README.md) — **rank #456 of 514** by impact score  

> **TL;DR** — Mu-GRPO is proposed, an RL training framework that organizes training into a small number of large sequential generation-optimization stages that induces high rollout staleness while greatly reducing rollout-optimization switching overhead, and establishes a substantially improved performance-efficiency trade-off for LLM reinforcement learning.
