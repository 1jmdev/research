...
**Category:** [Efficient reasoning (CoT compression, overthinking, adaptive thinking)](README.md) — **rank #323 of 359** by impact score  

> **TL;DR** — A test-time scaling method, EDIT (Efficient Dynamic Inference Trimming), is proposed, which efficiently guides LRMs to identify the shortest correct reasoning paths at test time, allowing it to select responses that strike an optimal balance between conciseness and correctness.
