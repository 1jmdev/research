...
**Category:** [Efficient reasoning (CoT compression, overthinking, adaptive thinking)](README.md) — **rank #83 of 359** by impact score  
**Also relevant to:** [Reinforcement learning for LLM reasoning (GRPO, RLVR)](../../training/rl-for-reasoning/README.md)  

> **TL;DR** — Decoupled Reward Policy Optimization (DRPO) is proposed, a novel framework that decouples the length-based learning signal of correct rollouts from incorrect ones, and demonstrates DRPO's significant superiority over six efficient reasoning baselines.
