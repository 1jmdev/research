...
**Category:** [Efficient reasoning (CoT compression, overthinking, adaptive thinking)](README.md) — **rank #186 of 359** by impact score  
...
> **TL;DR** — Budget-Guided MCTS is proposed, a tree-search decoding algorithm that aligns its search policy with the remaining token budget and consistently outperforms budget-agnostic tree-search baselines across inference budgets on mathematical reasoning benchmarks and an additional physics reasoning benchmark with open-weight LLMs.
