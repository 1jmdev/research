...
**Category:** [Efficient reasoning (CoT compression, overthinking, adaptive thinking)](README.md) — **rank #295 of 360** by impact score  

> **TL;DR** — Hierarchical Adaptive Budgeter is proposed, a training framework that operationalizes the principle of Thinking Economically: intelligently allocating computational resources based on intrinsic task and step demands rather than pursuing uniform brevity.
