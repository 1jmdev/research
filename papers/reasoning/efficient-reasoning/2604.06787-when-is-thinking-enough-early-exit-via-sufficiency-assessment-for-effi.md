...
**Category:** [Efficient reasoning (CoT compression, overthinking, adaptive thinking)](README.md) — **rank #155 of 360** by impact score  
**Also relevant to:** [Early exit, layer skipping & dynamic depth](../../decoding/early-exit-and-layer-skipping/README.md)  

> **TL;DR** — Dynamic Thought Sufficiency in Reasoning (DTSR) is introduced, a novel framework for efficient reasoning that enables the model to dynamically assess the sufficiency of its chain-of-thought (CoT) and determine the optimal point for early exit.
