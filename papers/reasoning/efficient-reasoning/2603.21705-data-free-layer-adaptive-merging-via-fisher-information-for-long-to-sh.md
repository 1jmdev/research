...
**Category:** [Efficient reasoning (CoT compression, overthinking, adaptive thinking)](README.md) — **rank #292 of 359** by impact score  
**Also relevant to:** [Model merging](../../model-conversion/model-merging/README.md)  

> **TL;DR** — This work provides the first theoretical justification for layer-adaptive merging: it is proved that merging error is bounded by a term proportional to the per-layer Hessian norm (Proposition~1), and it is established that the Fisher Information Matrix is a principled, computable proxy for this bound via the Fisher-Hessian equivalence at local optima.
