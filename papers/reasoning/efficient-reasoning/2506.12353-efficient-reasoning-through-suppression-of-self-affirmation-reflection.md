...
**Category:** [Efficient reasoning (CoT compression, overthinking, adaptive thinking)](README.md) — **rank #228 of 360** by impact score  

> **TL;DR** — This work focuses on Self-Affirmation Reflections: redundant reflective steps that affirm prior content and often occurs after the already correct reasoning steps, and can be directly applied to existing inference frameworks, such as vLLM.
