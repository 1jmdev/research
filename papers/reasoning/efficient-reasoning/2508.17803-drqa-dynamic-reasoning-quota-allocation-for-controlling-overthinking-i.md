...
**arXiv:** [2508.17803](https://arxiv.org/abs/2508.17803) · [PDF](https://arxiv.org/pdf/2508.17803) · [HTML](https://arxiv.org/html/2508.17803) · **First submitted:** 2025-11-07  
**Category:** [Efficient reasoning (CoT compression, overthinking, adaptive thinking)](README.md) — **rank #280 of 359** by impact score  

> **TL;DR** — By effectively mitigating the overthinking problem, DRQA offers a promising direction for more efficient and scalable deployment of RLLMs, and it is hoped it inspires further exploration into fine-grained control of reasoning behaviors.
...
```sh
arxiv read 2508.17803            # full paper as Markdown (github.com/1jmdev/arxiv)
arxiv section 2508.17803 "method"
arxiv bibtex 2508.17803
```
