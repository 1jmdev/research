...
**Category:** [Efficient reasoning (CoT compression, overthinking, adaptive thinking)](README.md) — **rank #356 of 360** by impact score  

> **TL;DR** — Experimental results demonstrate that the SKIP method effectively improves reasoning compression while mitigating performance degradation after fine-tuning, and shows strong generalization ability on out-of-distribution datasets.
