...
**arXiv:** [2507.04742](https://arxiv.org/abs/2507.04742) · [PDF](https://arxiv.org/pdf/2507.04742) · [HTML](https://arxiv.org/html/2507.04742) · **First submitted:** 2025-07-08  
**Category:** [Efficient reasoning (CoT compression, overthinking, adaptive thinking)](README.md) — **rank #85 of 359** by impact score  

> **TL;DR** — Activation-Steered Compression (ASC), an inference-time technique that shortens reasoning traces by directly modifying hidden representations, is formalized and provides a theoretical analysis of the impact of ASC on the output distribution, derived from a closed-form KL-divergence-bounded constraint to regulate steering strength.
...
- Using only 100 paired verbose and concise examples, ASC achieves up to 67.43% reduction in CoT length on MATH500 and GSM8K datasets, while maintaining accuracy across 7B, 8B, and 32B parameter models.
- As a training-free method, ASC introduces negligible runtime overhead and, on MATH500, delivers an average 2.73x speedup in end-to-end reasoning wall-clock time on an 8B model.
...
```sh
arxiv read 2507.04742            # full paper as Markdown (github.com/1jmdev/arxiv)
arxiv section 2507.04742 "method"
arxiv bibtex 2507.04742
```
