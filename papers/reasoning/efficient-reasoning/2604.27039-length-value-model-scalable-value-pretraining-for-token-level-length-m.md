...
**Category:** [Efficient reasoning (CoT compression, overthinking, adaptive thinking)](README.md) — **rank #138 of 360** by impact score  

> **TL;DR** — The Length Value Model (LenVM), a token-level framework that estimates the remaining generation length at every decoding step, is introduced, establishing generation length as an effective scalable token-level value signal for control, prediction, and future value-based training.
