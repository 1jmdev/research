...
**Category:** [Efficient reasoning (CoT compression, overthinking, adaptive thinking)](README.md) — **rank #300 of 360** by impact score  

> **TL;DR** — This work proposes SABER, a training-free framework for stability-aware early exit via adversarial branch probing, and shows that SABER reduces reasoning token consumption by 30.2% on average while maintaining competitive accuracy with full-length reasoning.
