...
**Category:** [Efficient reasoning (CoT compression, overthinking, adaptive thinking)](README.md) — **rank #237 of 360** by impact score  

> **TL;DR** — Analysis reveals a distinct phenomenon: the reasoning termination token acts as an information anchor, where its attention pattern effectively demarcates essential reasoning from redundancy, and designs a policy that utilizes these intrinsic attention signals to guide atomic compression operations.
