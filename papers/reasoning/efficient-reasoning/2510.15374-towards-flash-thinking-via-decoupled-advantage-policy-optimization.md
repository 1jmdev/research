...
**Category:** [Efficient reasoning (CoT compression, overthinking, adaptive thinking)](README.md) — **rank #275 of 360** by impact score  

> **TL;DR** — A novel RL framework, DEPO, is proposed to reduce inefficient reasoning for models and achieves a significant reduction in sequence length and reduces excessive reasoning paths in inefficient tokens, while outperforming the base model in overall accuracy.
