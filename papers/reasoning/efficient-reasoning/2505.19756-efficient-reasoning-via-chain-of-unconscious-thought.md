...
**Category:** [Efficient reasoning (CoT compression, overthinking, adaptive thinking)](README.md) — **rank #198 of 360** by impact score  

> **TL;DR** — This work proposes a new reasoning paradigm, termed Chain of Unconscious Thought (CoUT), to improve the token efficiency of large Reasoning Models by guiding them to mimic human unconscious thought and internalize reasoning processes.
