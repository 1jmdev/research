...
**Category:** [Latent reasoning, looped & recurrent-depth models](README.md) — **rank #119 of 166** by impact score  

> **TL;DR** — This work proposes Selective Latent Thinking (SLT), a framework that selectively compresses redundant reasoning spans into latent representations while preserving precision-critical spans as explicit CoT within the same reasoning trajectory.
