...
**Category:** [Latent reasoning, looped & recurrent-depth models](README.md) — **rank #133 of 166** by impact score  

> **TL;DR** — One-Model One-Step is introduced, a novel compression framework for Latent Reasoning with Rule-Based Priors(RuPLaR) to address the challenge of eliminating cascaded processes and inter-model dependencies in latent CoT reasoning.
