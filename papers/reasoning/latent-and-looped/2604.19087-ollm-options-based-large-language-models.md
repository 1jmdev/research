...
**Category:** [Latent reasoning, looped & recurrent-depth models](README.md) — **rank #145 of 166** by impact score  

> **TL;DR** — The results demonstrate that optionized next-token modeling enhances controllability, robustness, and efficiency in math reasoning, and highlight latent-space policy learning as a promising direction for reinforcement learning in LLMs.
