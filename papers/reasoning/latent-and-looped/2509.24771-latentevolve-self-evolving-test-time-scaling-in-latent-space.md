...
**Category:** [Latent reasoning, looped & recurrent-depth models](README.md) — **rank #86 of 166** by impact score  
**Also relevant to:** [Test-time scaling & inference-time compute](../test-time-scaling/README.md)  

> **TL;DR** — LatentEvolve is proposed, a self-evolving latent TTS framework inspired by the complementary learning system (CLS) theory that surpasses state-of-the-art TTS methods such as LatentSeek and TTRL by up to $13.33\% and exhibits exceptional cross-domain and cross-backbone generalization.
