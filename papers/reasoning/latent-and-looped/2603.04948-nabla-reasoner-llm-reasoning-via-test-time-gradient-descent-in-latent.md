...
**Category:** [Latent reasoning, looped & recurrent-depth models](README.md) — **rank #50 of 158** by impact score  

> **TL;DR** — Gradient-based optimization integrated into LLM decoding enables efficient reasoning enhancement with reduced model calls.
