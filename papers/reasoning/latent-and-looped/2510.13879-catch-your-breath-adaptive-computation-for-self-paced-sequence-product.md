...
**Category:** [Latent reasoning, looped & recurrent-depth models](README.md) — **rank #113 of 166** by impact score  

> **TL;DR** — A supervised loss, Catch Your Breath (CYB), framed as a sequential-decision problem, that trains a model to dynamically and autonomously scale the number of compute steps used for each input token is proposed, reducing perplexity and enhancing downstream accuracy with no additional computational or memory cost.
