...
**Category:** [Latent reasoning, looped & recurrent-depth models](README.md) — **rank #72 of 166** by impact score  

> **TL;DR** — MarCos is proposed, an improvement of the transformer structure that allows fully continuous reasoning at the thought level and observes that the increased information bandwidth of MarCos elicits the ability of parallel thinking, in contrast to single-threaded thinking in traditional transformers.
