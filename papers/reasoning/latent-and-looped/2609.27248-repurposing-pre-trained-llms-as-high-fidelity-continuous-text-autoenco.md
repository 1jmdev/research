...
**Category:** [Latent reasoning, looped & recurrent-depth models](README.md) — **rank #166 of 166** by impact score  

> **TL;DR** — LLMAE, a method for repurposing a pretrained decoder-only language model as a continuous text autoencoder by exposing an intermediate fixed-length latent bottleneck within its internal activations, is proposed and trained to reconstruct text sequences up to 1024 tokens.
