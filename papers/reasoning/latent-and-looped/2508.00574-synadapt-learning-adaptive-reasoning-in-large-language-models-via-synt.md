...
**Category:** [Latent reasoning, looped & recurrent-depth models](README.md) — **rank #80 of 166** by impact score  

> **TL;DR** — This work proposes an innovative efficient reasoning framework that generates the synthetic CCoT to serve as a precise and effective alignment target for LLMs, and integrates a difficulty classifier that leverages both question context and CCoT to identify hard questions.
