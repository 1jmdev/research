...
**Category:** [Latent reasoning, looped & recurrent-depth models](README.md) — **rank #96 of 166** by impact score  

> **TL;DR** — This work shows how a policy improvement perspective on recursive steps can explain model behavior and provide insights for further improvements, and proposes to use a training schemes from reinforcement learning and diffusion methods for latent reasoning models.
