...
**Category:** [Latent reasoning, looped & recurrent-depth models](README.md) — **rank #41 of 158** by impact score  
**Also relevant to:** [Pre-training recipes & efficiency](../../training/pretraining-recipes-and-efficiency/README.md)  

> **TL;DR** — Reinforcement pre-training framework LoopRPT improves latent reasoning in looped language models by directly shaping intermediate representations through next-token reasoning tasks.
