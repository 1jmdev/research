...
**Category:** [Latent reasoning, looped & recurrent-depth models](README.md) — **rank #87 of 166** by impact score  

> **TL;DR** — This paper proposes learning a shared representation space that aligns the k-v caches of multiple models, creating a high-bandwidth channel for collaboration without altering the underlying pre-trained parameters.
