...
**Category:** [Latent reasoning, looped & recurrent-depth models](README.md) — **rank #147 of 166** by impact score  

> **TL;DR** — Reasoning in Memory is introduced, a latent reasoning method that replaces the autoregressive generation of reasoning steps with memory blocks that unlock the working-memory capacity of large language models and matches or exceeds existing latent reasoning methods while avoiding the autoregressive generation of thoughts.
