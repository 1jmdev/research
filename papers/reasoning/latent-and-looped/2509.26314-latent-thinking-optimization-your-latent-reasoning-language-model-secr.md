...
**Category:** [Latent reasoning, looped & recurrent-depth models](README.md) — **rank #61 of 166** by impact score  

> **TL;DR** — This paper provides a systematic study of how Huginn-3.5B thinks in the latent space and how external supervision signals can improve its latent thinking processes and proposes Latent Thinking Optimization (LTO), a probabilistic algorithm that employs the latent classifier as a Latent Reward Model (LRM) to optimize the latent thinking processes.
