...
**Category:** [Latent reasoning, looped & recurrent-depth models](README.md) — **rank #43 of 166** by impact score  

> **TL;DR** — This work proposes Latent Thoughts Tuning (LT-Tuning), a post-training framework that redefines how latent thoughts are constructed and deployed and introduces a Context-Prediction-Fusion mechanism that jointly leverages contextual hidden states and predictive semantic guidance from the vocabulary embedding space.
