...
**Category:** [Latent reasoning, looped & recurrent-depth models](README.md) — **rank #7 of 166** by impact score  

> **TL;DR** — SIM-CoT significantly improves both in-domain accuracy and out-of-domain stability of implicit CoT methods, boosting Coconut by +8.2\% on GPT-2 and CODI by +3.0\% on LLaMA-3.1 8B.
