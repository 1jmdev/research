...
**Category:** [Latent reasoning, looped & recurrent-depth models](README.md) — **rank #47 of 166** by impact score  

> **TL;DR** — This work introduces Latent-SFT, a unified framework addressing challenges at three levels: token, chain, and learning, and confirms that the method effectively captures a superposition of diverse reasoning trajectories rather than merely compressing a single path.
