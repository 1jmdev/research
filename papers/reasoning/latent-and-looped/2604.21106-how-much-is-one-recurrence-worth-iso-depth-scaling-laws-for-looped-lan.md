...
**Category:** [Latent reasoning, looped & recurrent-depth models](README.md) — **rank #35 of 166** by impact score  
**Also relevant to:** [Scaling laws](../../training/scaling-laws/README.md)  

> **TL;DR** — The utility of $\varphi$ is demonstrated as a diagnostic tool on two case studies, indicating that the loop mechanism is poorly trained under truncation, even though validation loss decreases.
