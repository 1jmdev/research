...
**Category:** [Latent reasoning, looped & recurrent-depth models](README.md) — **rank #155 of 166** by impact score  

> **TL;DR** — HALO is introduced, a hybrid adaptive latent-refinement method that combines a coarse refinement stage with selective second-stage latent refinement on a subset of tokens chosen by token scoring and monotonic token halting and achieves the strongest paper-facing result while also using less measured controller compute than either fixed baseline.
