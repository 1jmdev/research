...
**arXiv:** [2606.16360](https://arxiv.org/abs/2606.16360) · [PDF](https://arxiv.org/pdf/2606.16360) · [HTML](https://arxiv.org/html/2606.16360) · **First submitted:** 2026-06-15  
**Category:** [Latent reasoning, looped & recurrent-depth models](README.md) — **rank #127 of 166** by impact score  

> **TL;DR** — Tyler is proposed, a typed and budget-aware framework for latent reasoning during autoregressive decoding that generalizes across diverse reasoning domains and achieves the best final-stage performance with the lowest forgetting.
...
| arXiv comments | website: https://typed-latent-reasoning.github.io |
...
- Across extensive experiments on three backbone LLMs, Tyler improves accuracy by up to 14.49 points over CoT and by up to 4.30 points over the strongest competing baseline.
...
```sh
arxiv read 2606.16360            # full paper as Markdown (github.com/1jmdev/arxiv)
arxiv section 2606.16360 "method"
arxiv bibtex 2606.16360
```
