...
**Category:** [Latent reasoning, looped & recurrent-depth models](README.md) — **rank #53 of 166** by impact score  

> **TL;DR** — A taxonomy centered on execution paradigms is introduced, shifting the focus from representational forms to computational strategies, and existing methods are organized into three execution paradigms based on how and where internal computation unfolds.
...
| Citations (Semantic Scholar, 2026-09-25) | 43 (0 influential) |
