...
**Category:** [Latent reasoning, looped & recurrent-depth models](README.md) — **rank #150 of 166** by impact score  

> **TL;DR** — ReLAT (Reconstruction-Guided Latent Reasoning At Test Time), a self-supervised test-time training method that closes this loop using the query itself as the reference and consistently improves over single-model inference, text-based collaboration, open-loop latent collaboration, and alternative test-time training objectives.
