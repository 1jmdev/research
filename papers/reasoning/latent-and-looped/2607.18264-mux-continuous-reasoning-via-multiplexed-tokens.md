...
- Across 32 evaluation settings spanning four language models, MUX outperforms strong latent reasoning baselines.
...
```sh
arxiv read 2607.18264            # full paper as Markdown (github.com/1jmdev/arxiv)
arxiv section 2607.18264 "method"
arxiv bibtex 2607.18264
```
