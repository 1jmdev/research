...
**Category:** [Latent reasoning, looped & recurrent-depth models](README.md) — **rank #91 of 166** by impact score  
...
> **TL;DR** — This work study the minimal parameter budget required for implicit reasoning, defined as the ability to infer new facts from learned knowledge without explicit chain-of-thought supervision, and identifies a scaling law linking this optimal parameter budget to a graph search entropy measure.
