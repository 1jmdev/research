...
**Category:** [Test-time scaling & inference-time compute](README.md) — **rank #41 of 217** by impact score  

> **TL;DR** — A unified evaluation across diverse domains shows that generative outcome reward models outperform process reward models and discriminative outcome reward models in assessing large language model reliability.
