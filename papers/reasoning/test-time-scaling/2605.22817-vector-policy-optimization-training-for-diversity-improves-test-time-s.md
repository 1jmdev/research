...
**Category:** [Test-time scaling & inference-time compute](README.md) — **rank #141 of 226** by impact score  

> **TL;DR** — This work proposes Vector Policy Optimization (VPO), an RL algorithm that explicitly trains policies to anticipate diverse downstream reward functions and to produce diverse solutions in order to solve problems that GRPO models cannot solve at all.
