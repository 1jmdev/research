...
**Category:** [Test-time scaling & inference-time compute](README.md) — **rank #131 of 227** by impact score  
**Also relevant to:** [Sampling & decoding strategies](../../decoding/sampling-and-strategies/README.md)  

> **TL;DR** — The findings suggest that TTS is more powerful than previously thought, and that temperature scaling offers a simple and effective way to unlock the latent potential of base models.
