...
**Category:** [Test-time scaling & inference-time compute](README.md) — **rank #202 of 226** by impact score  

> **TL;DR** — ThinkBooster is introduced, a unified framework for seamless test-time compute scaling of LLM reasoning that consists of a modular Python library implementing state-of-the-art TTC scaling strategy and scorer families, a benchmark that jointly evaluates performance and computational efficiency, and a deployable OpenAI-compatible proxy service that enables drop-in integration of adaptive reasoning into real-world applications.
