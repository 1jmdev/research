...
**arXiv:** [2605.10716](https://arxiv.org/abs/2605.10716) · [PDF](https://arxiv.org/pdf/2605.10716) · [HTML](https://arxiv.org/html/2605.10716) · **First submitted:** 2026-05-11  
**Category:** [Test-time scaling & inference-time compute](README.md) — **rank #217 of 226** by impact score  
**Also relevant to:** [Reinforcement learning for LLM reasoning (GRPO, RLVR)](../../training/rl-for-reasoning/README.md)  

> **TL;DR** — Under structural assumptions on the reward tails, it is shown that the policy gradient of the best-of-N objective can be approximated from a much smaller rollout group by extrapolating upper-tail statistics, which yields a family of Tail-Extrapolated estimators for best-of-N-oriented post-training.
...
```sh
arxiv read 2605.10716            # full paper as Markdown (github.com/1jmdev/arxiv)
arxiv section 2605.10716 "method"
arxiv bibtex 2605.10716
```
