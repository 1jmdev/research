...
**Category:** [Test-time scaling & inference-time compute](README.md) — **rank #193 of 227** by impact score  
**Also relevant to:** [Serving & inference systems — general](../../serving-systems/_general/README.md)  

> **TL;DR** — This work proposes to train Divide-and-Conquer CoT (DC-CoT) to reduce the latency, and designs a multi-stage RL algorithm, with various data filtering strategies, to recover the accuracy while decreasing the longest path length.
