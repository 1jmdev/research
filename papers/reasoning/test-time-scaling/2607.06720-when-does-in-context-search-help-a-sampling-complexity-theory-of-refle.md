...
**arXiv:** [2607.06720](https://arxiv.org/abs/2607.06720) · [PDF](https://arxiv.org/pdf/2607.06720) · [HTML](https://arxiv.org/html/2607.06720) · **First submitted:** 2026-07-07  
**Category:** [Test-time scaling & inference-time compute](README.md) — **rank #193 of 226** by impact score  

> **TL;DR** — A theoretical analysis of in-context search is provided by modeling it as approximate inference over reasoning traces, where the base model defines a prior and self-reflection provides feedback for posterior updates, and the resulting inference-time sampling complexity is studied.
...
```sh
arxiv read 2607.06720            # full paper as Markdown (github.com/1jmdev/arxiv)
arxiv section 2607.06720 "method"
arxiv bibtex 2607.06720
```
