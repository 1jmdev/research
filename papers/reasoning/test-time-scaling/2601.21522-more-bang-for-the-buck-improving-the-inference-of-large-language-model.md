...
**Category:** [Test-time scaling & inference-time compute](README.md) — **rank #143 of 227** by impact score  

> **TL;DR** — Experiments on three LLMs across coding, math, and reasoning benchmarks demonstrate that ReD substantially reduces the required attempts, tokens, and USD cost to reach a desired coverage, while also offering an efficient way to measure inference power-laws.
