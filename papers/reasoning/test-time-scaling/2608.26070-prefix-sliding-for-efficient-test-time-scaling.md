...
**Category:** [Test-time scaling & inference-time compute](README.md) — **rank #79 of 217** by impact score  

> **TL;DR** — Prefix Sliding reduces memory costs during long reasoning by discarding unimportant intermediate tokens, enabling efficient test-time scaling without retraining.
