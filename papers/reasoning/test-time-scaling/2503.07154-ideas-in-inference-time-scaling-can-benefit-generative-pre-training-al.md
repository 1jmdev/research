...
**Category:** [Test-time scaling & inference-time compute](README.md) — **rank #82 of 227** by impact score  
**Also relevant to:** [Pre-training recipes & efficiency](../../training/pretraining-recipes-and-efficiency/README.md)  

> **TL;DR** — This work argues that the dichotomy between autoregressive models for discrete signals and diffusion models for continuous signals is false, and advocates designing the inference procedure before the training objective, because a training method cannot compensate for an inference map that omits necessary arguments or imposes an incorrect factorization.
