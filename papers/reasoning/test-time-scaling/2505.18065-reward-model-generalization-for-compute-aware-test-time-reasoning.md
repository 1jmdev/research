...
**Category:** [Test-time scaling & inference-time compute](README.md) — **rank #214 of 227** by impact score  

> **TL;DR** — This work establishes a theoretical framework to analyze how the generalization error of the PRM affects compute efficiency and reasoning performance, and proposes Compute-Aware Tree Search (CATS), an actor-critic framework that dynamically controls search behavior.
