...
**arXiv:** [2607.01179](https://arxiv.org/abs/2607.01179) · [PDF](https://arxiv.org/pdf/2607.01179) · [HTML](https://arxiv.org/html/2607.01179) · **First submitted:** 2026-07-01  
**Category:** [Test-time scaling & inference-time compute](README.md) — **rank #196 of 226** by impact score  

> **TL;DR** — This work introduces QuasiMoTTo, which uses correlated samples as a drop-in replacement for i.i.d. samples, and empirical analysis focuses on understanding how efficiently QuasiMoTTo can turn compute into performance.
...
- Across four reasoning benchmarks, QuasiMoTTo matches i.i.d. pass@k accuracy with 25-47% fewer samples.
- We also apply QuasiMoTTo to policy-gradient RL (GRPO) where it matches i.i.d. performance with 50% fewer training steps.
...
```sh
arxiv read 2607.01179            # full paper as Markdown (github.com/1jmdev/arxiv)
arxiv section 2607.01179 "method"
arxiv bibtex 2607.01179
```
