...
**Category:** [Test-time scaling & inference-time compute](README.md) — **rank #68 of 217** by impact score  

> **TL;DR** — A three-stage framework, SPARK, uses a generator and verifier to create synthetic training data for process reward models, enabling reference-free reinforcement learning that surpasses ground-truth methods in mathematical reasoning tasks.
