...
**Category:** [Test-time scaling & inference-time compute](README.md) — **rank #51 of 217** by impact score  

> **TL;DR** — STOP is a systematic path pruning method for large reasoning models that improves efficiency and accuracy through learnable token-level pruning across different compute budgets.
