...
**Category:** [Test-time scaling & inference-time compute](README.md) — **rank #174 of 227** by impact score  
**Also relevant to:** [Latent reasoning, looped & recurrent-depth models](../latent-and-looped/README.md)  

> **TL;DR** — It is argued that the training frameworks for continuous reasoning LMs require not only to optimize for accuracy but also to explicitly incorporate inductive biases that could be utilized during inference-time for discrimination of correct and incorrect thoughts.
