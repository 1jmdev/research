...
**Category:** [Test-time scaling & inference-time compute](README.md) — **rank #64 of 217** by impact score  

> **TL;DR** — Unsupervised reward models eliminate the need for human annotations in training by leveraging language model next-token probabilities to identify erroneous reasoning steps and improve policy optimization in reinforcement learning.
