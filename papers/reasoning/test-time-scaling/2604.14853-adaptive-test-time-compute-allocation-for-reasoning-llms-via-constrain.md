...
**Category:** [Test-time scaling & inference-time compute](README.md) — **rank #131 of 226** by impact score  
**Also relevant to:** [Reinforcement learning for LLM reasoning (GRPO, RLVR)](../../training/rl-for-reasoning/README.md)  

> **TL;DR** — This work formalizes this as a constrained optimization problem (maximize expected accuracy subject to an average compute budget) and solves it with a two-stage Solve-then-Learn pipeline, establishing that the task-level regret of the learned policy is bounded by its imitation error times the worst-case per-instance gap.
