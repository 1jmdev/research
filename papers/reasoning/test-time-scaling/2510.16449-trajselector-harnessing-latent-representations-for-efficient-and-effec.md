...
**Category:** [Test-time scaling & inference-time compute](README.md) — **rank #104 of 217** by impact score  

> **TL;DR** — TrajSelector is an efficient Best-of-N framework that leverages hidden states for process-level scoring, improving LLM performance with lower computational costs.
