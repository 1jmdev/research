...
**Category:** [Test-time scaling & inference-time compute](README.md) — **rank #60 of 226** by impact score  

> **TL;DR** — Reasoning-Driven Process Reward Modeling (R-PRM) leverage stronger LLMs to generate seed data from limited annotations, effectively bootstrapping the model's reasoning capabilities and enabling comprehensive step-by-step evaluation.
...
| Citations (Semantic Scholar, 2026-09-25) | 48 (5 influential) |
