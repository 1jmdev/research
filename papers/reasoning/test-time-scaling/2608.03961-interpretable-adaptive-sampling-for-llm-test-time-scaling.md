...
**arXiv:** [2608.03961](https://arxiv.org/abs/2608.03961) · [PDF](https://arxiv.org/pdf/2608.03961) · [HTML](https://arxiv.org/html/2608.03961) · **First submitted:** 2026-08-04  
**Category:** [Test-time scaling & inference-time compute](README.md) — **rank #188 of 227** by impact score  

> **TL;DR** — Adaptive test-time scaling with a lightweight fuzzy controller that maps interpretable signals, including estimated prompt complexity and model confidence, to a per-query sampling budget is proposed, suggesting that interpretable adaptive sampling is a practical direction for more efficient test-time reasoning in large language models.
...
```sh
arxiv read 2608.03961            # full paper as Markdown (github.com/1jmdev/arxiv)
arxiv section 2608.03961 "method"
arxiv bibtex 2608.03961
```
