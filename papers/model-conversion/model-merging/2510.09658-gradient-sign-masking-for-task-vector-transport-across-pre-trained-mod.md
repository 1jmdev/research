...
> **TL;DR** — This work proposes GradFix, which approximates the ideal sign structure of the new model and leverages it to transfer knowledge using only a handful of labeled samples and shows that transporting task vectors improves multi-task and multi-source model merging.
