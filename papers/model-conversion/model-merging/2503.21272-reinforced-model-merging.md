...
**arXiv:** [2503.21272](https://arxiv.org/abs/2503.21272) · [PDF](https://arxiv.org/pdf/2503.21272) · [HTML](https://arxiv.org/html/2503.21272) · **First submitted:** 2025-03-27  
**Category:** [Model merging](README.md) — **rank #67 of 102** by impact score  

> **TL;DR** — An innovative framework termed Reinforced Model Merging (RMM), which encompasses an environment and agent tailored for merging tasks that achieves state-of-the-art performance across various vision and NLP datasets and effectively overcomes the limitations of the existing baseline methods.
...
| Code | https://github.com/WuDiHJQ/Reinforced-Model-Merging |
| Training requirement (from abstract) | training-free / post-training |
| Impact score | 0.74 |

## Key results (claimed in abstract)

- Furthermore, by utilizing data subsets during the evaluation process, we addressed the bottleneck in the reward feedback phase, thereby accelerating RMM by up to 100 times.
...
```sh
arxiv read 2503.21272            # full paper as Markdown (github.com/1jmdev/arxiv)
arxiv section 2503.21272 "method"
arxiv bibtex 2503.21272
```
