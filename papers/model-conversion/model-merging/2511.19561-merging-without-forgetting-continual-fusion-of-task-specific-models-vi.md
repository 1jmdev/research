...
**Category:** [Model merging](README.md) — **rank #87 of 102** by impact score  

> **TL;DR** — This paper proposes OTMF (Optimal Transport-based Masked Fusion), a novel model merging framework rooted in optimal transport theory to address the distribution shift that arises from naive parameter interpolation and achieves state-of-the-art performance in terms of both accuracy and efficiency.
