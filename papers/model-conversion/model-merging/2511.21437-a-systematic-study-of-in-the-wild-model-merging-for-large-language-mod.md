...
**Category:** [Model merging](README.md) — **rank #52 of 102** by impact score  
**Also relevant to:** [MoE compression (expert pruning, merging, quantization)](../../mixture-of-experts/compression/README.md)  

> **TL;DR** — A large-scale, systematic evaluation of "in-the-wild" model merging of heterogeneous experts, that may have been trained on overlapping or conflicting objectives, and shows that the oldest and simplest method, Task Arithmetic, is the only approach that reliably yields performance gains on LLMs in this"in-the-wild"setting.
