...
**Category:** [Model merging](README.md) — **rank #59 of 102** by impact score  

> **TL;DR** — DiDi-Merging is proposed, a slim dynamic merging framework that leverages differentiable rank allocation to balance shared and expert parameters and matches prior dynamic baselines at only 1.24x the parameters of a single fine-tuned model.
