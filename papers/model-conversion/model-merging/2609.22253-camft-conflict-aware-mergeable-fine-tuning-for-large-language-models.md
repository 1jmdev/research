...
> **TL;DR** — CAMFT is proposed, a Conflict-Aware Mergeable Fine-Tuning method that makes task adaptation both efficient and mergeaware and treats mergeability as a property shaped during fine-tuning, rather than only a problem to be solved after fine-tuning.
