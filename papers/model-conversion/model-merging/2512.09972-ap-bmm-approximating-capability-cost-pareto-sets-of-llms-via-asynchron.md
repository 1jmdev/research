...
**Category:** [Model merging](README.md) — **rank #88 of 102** by impact score  

> **TL;DR** — Asynchronous Prior-Guided Bayesian Model Merging (AP-BMM), which formulates layer-wise merging as a multi-objective optimization problem to approximate a Pareto set of merged LLMs, yielding a family of Pareto-optimal merged models with diverse capability--cost trade-offs.
