...
**Category:** [Model merging](README.md) — **rank #30 of 102** by impact score  

> **TL;DR** — This work argues that linearity already exists within the model's submodules, and proposes an innovative model merging strategy that independently merges these submodules to derive a closed-form solution for optimal merging weights grounded in the linear properties of these submodules.
