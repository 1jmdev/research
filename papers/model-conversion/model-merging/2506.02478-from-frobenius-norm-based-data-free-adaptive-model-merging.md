...
**Category:** [Model merging](README.md) — **rank #63 of 102** by impact score  

> **TL;DR** — An adaptive merging method called FroM is proposed, which directly measures the model parameters using the Frobenius norm, without any training data, and outperforms baseline methods across various fine-tuning scenarios, alleviating the task interference problem.
