...
**arXiv:** [2608.12842](https://arxiv.org/abs/2608.12842) · [PDF](https://arxiv.org/pdf/2608.12842) · [HTML](https://arxiv.org/html/2608.12842) · **First submitted:** 2026-08-13  
**Category:** [Model merging](README.md) — **rank #98 of 102** by impact score  

> **TL;DR** — Adaptive Weight Allocation (AWA) optimizes merging coefficients via a gradient-free search scheme to reduce time complexity, while an asymmetric fitness function promotes more comprehensive performance gains across tasks.
...
```sh
arxiv read 2608.12842            # full paper as Markdown (github.com/1jmdev/arxiv)
arxiv section 2608.12842 "method"
arxiv bibtex 2608.12842
```
