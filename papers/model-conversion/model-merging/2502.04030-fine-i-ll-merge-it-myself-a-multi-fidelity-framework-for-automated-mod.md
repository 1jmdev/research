...
**Category:** [Model merging](README.md) — **rank #51 of 102** by impact score  

> **TL;DR** — This work proposes an Automated Model Merging Framework that enables fine-grained exploration of merging strategies while reducing costs through multi-fidelity approximations and introduces two novel search spaces: layerwise fusion (LFS) and depth-wise integration (DIS).
