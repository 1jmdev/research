...
**Category:** [Model merging](README.md) — **rank #92 of 102** by impact score  

> **TL;DR** — This work derives a practical fixed-point algorithm using a lightweight spherical proxy that preserves norms and generalizes directly to multi-expert merging and remains stable as the number and heterogeneity of merged models increase, consistently outperforming prior baselines.
