...
**Category:** [Model merging](README.md) — **rank #50 of 102** by impact score  

> **TL;DR** — Layer-Aware Task Arithmetic (LATA), a novel approach that assigns layer-specific weights to task vectors based on their alignment with instruction-following or task-specific components, is proposed, offering a robust framework for efficient model merging and editing.
