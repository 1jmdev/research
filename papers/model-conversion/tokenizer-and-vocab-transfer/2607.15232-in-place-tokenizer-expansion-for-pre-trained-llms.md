...
**arXiv:** [2607.15232](https://arxiv.org/abs/2607.15232) · [PDF](https://arxiv.org/pdf/2607.15232) · [HTML](https://arxiv.org/html/2607.15232) · **First submitted:** 2026-07-16  
**Category:** [Tokenizer / vocabulary transfer & cross-tokenizer distillation](README.md) — **rank #26 of 27** by impact score  
...
- Combining these reductions with the measured per-token cost of the larger vocabulary, we estimate a $2.2$-$3.7\times$ per-character decode speedup for these languages across our reference devices.
...
```sh
arxiv read 2607.15232            # full paper as Markdown (github.com/1jmdev/arxiv)
arxiv section 2607.15232 "method"
arxiv bibtex 2607.15232
```
