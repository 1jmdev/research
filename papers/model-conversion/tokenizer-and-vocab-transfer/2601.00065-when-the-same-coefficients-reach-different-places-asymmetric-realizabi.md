...
> **TL;DR** — Tokenizer transplant in cross-vocabulary model composition reconstructs donor-only embedding rows as weighted combinations over shared lexical anchors and reuses those coefficients on the base, finding a structural geometric property of this reconstruction that identifies a structural geometric property of this reconstruction.
