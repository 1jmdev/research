...
**arXiv:** [2609.27746](https://arxiv.org/abs/2609.27746) · [PDF](https://arxiv.org/pdf/2609.27746) · [HTML](https://arxiv.org/html/2609.27746) · **First submitted:** 2026-09-23  
**Category:** [Prefix caching & KV reuse (RAG, multi-turn, agents)](README.md) — **rank #105 of 106** by impact score  
**Also relevant to:** [Request scheduling, batching & SLO serving](../../serving-systems/scheduling-and-batching/README.md) · [State-space models & recurrent LMs (Mamba, RWKV, xLSTM)](../../attention/state-space-and-recurrent/README.md) · [KV cache — general, systems & analysis](../_general/README.md)  

> **TL;DR** — KVSET, an online analyzer that estimates the KV cache working set of LLM serving workloads, substantially reduces the computational and memory overhead of conventional capacity-by-capacity simulation and makes online working-set analysis practical.
...
```sh
arxiv read 2609.27746            # full paper as Markdown (github.com/1jmdev/arxiv)
arxiv section 2609.27746 "method"
arxiv bibtex 2609.27746
```
