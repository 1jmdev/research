...
> **TL;DR** — Tail-Optimized LRU is proposed, a simple two-line modification that reallocates KV cache capacity to prioritize high-latency conversations by evicting cache entries that are unlikely to affect future turns, providing the first theoretical justification for LRU in this setting.
