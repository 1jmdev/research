...
**arXiv:** [2609.04748](https://arxiv.org/abs/2609.04748) · [PDF](https://arxiv.org/pdf/2609.04748) · [HTML](https://arxiv.org/html/2609.04748) · **First submitted:** 2026-09-04  
**Category:** [Prefix caching & KV reuse (RAG, multi-turn, agents)](README.md) — **rank #96 of 106** by impact score  

> **TL;DR** — This work runs an eighty-episode multi-turn agentic tool-use workload with caching enabled and disabled across two engines and four weight formats, and shows the divergence reaching task outcomes without shifting aggregate accuracy.
...
```sh
arxiv read 2609.04748            # full paper as Markdown (github.com/1jmdev/arxiv)
arxiv section 2609.04748 "method"
arxiv bibtex 2609.04748
```
