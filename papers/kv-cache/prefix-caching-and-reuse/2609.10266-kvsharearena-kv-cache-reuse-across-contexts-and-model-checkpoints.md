...
**arXiv:** [2609.10266](https://arxiv.org/abs/2609.10266) · [PDF](https://arxiv.org/pdf/2609.10266) · [HTML](https://arxiv.org/html/2609.10266) · **First submitted:** 2026-09-09  
**Category:** [Prefix caching & KV reuse (RAG, multi-turn, agents)](README.md) — **rank #99 of 106** by impact score  
...
> **TL;DR** — KVShareArena benchmarks KV-cache reuse across prompt contexts and model checkpoints on retrieved chunks and agent reports, and finds that correcting positions, which needs no recomputation, is enough until a question needs several sources at once.
...
```sh
arxiv read 2609.10266            # full paper as Markdown (github.com/1jmdev/arxiv)
arxiv section 2609.10266 "method"
arxiv bibtex 2609.10266
```
