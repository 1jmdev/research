...
| 4 | [OjaKV: Context-Aware Online Low-Rank KV Cache Compression](2509.21623-ojakv-context-aware-online-low-rank-kv-cache-compression.md) | 2026-04-16 | 3.39 | 6 | 0 | Annual Meeting of the Association for Co | [✓](https://github.com/zzbright1998/OjaKV) | OjaKV is introduced, a novel framework that integrates a strategic hybrid storage policy with online subspace adaptation that achieves its strongest gains on … |
...
| 6 | [TPLA: Tensor Parallel Latent Attention for Efficient Disaggregated Prefill and Decode Inference](2508.15881-tpla-tensor-parallel-latent-attention-for-efficient-disaggregated-pref.md) | 2025-08-25 | 3.2 | 2 | 10 |  |  | Tensor-Parallel Latent Attention (TPLA) is proposed, a scheme that partitions both the latent representation and each head's input dimension across devices, … |
| 7 | [Efficient Low Rank Attention for Long-Context Inference in Large Language Models](2510.23649-efficient-low-rank-attention-for-long-context-inference-in-large-langu.md) | 2025-12-23 | 3.14 | 4 | 0 | NeurIPS 2025 | [✓](https://github.com/tenghuilee/LRQK) | Low Rank Query and Key attention is introduced, a two-stage framework that jointly decomposes full-precision query and key matrices into compact rank-\(r\) … |
