...
**arXiv:** [2604.15356](https://arxiv.org/abs/2604.15356) · [PDF](https://arxiv.org/pdf/2604.15356) · [HTML](https://arxiv.org/html/2604.15356) · **First submitted:** 2026-04-10  
...
> **TL;DR** — This work introduces sequential KV compression, a two-layer architecture that compose with existing per-vector quantization methods including TurboQuant, with compression improving rather than degrading as context length grows.
...
| arXiv categories | cs.LG, cs.AI, cs.IT, cs.NE, math.IT |
...
- We prove that at typical language model perplexity -- approximately 10-20 for fluent English text -- this bound is 3.3-4.3 bits on average per token position, compared to TurboQuant's 3 bits per vector component (with typical attention heads having 64-128 components).
...
```sh
arxiv read 2604.15356            # full paper as Markdown (github.com/1jmdev/arxiv)
arxiv section 2604.15356 "method"
arxiv bibtex 2604.15356
```
