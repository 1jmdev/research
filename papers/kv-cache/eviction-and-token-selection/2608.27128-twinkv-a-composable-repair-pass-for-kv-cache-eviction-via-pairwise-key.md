...
**arXiv:** [2608.27128](https://arxiv.org/abs/2608.27128) · [PDF](https://arxiv.org/pdf/2608.27128) · [HTML](https://arxiv.org/html/2608.27128) · **First submitted:** 2026-08-31  
**Category:** [KV cache eviction / token selection / sparse retrieval](README.md) — **rank #231 of 240** by impact score  
**Also relevant to:** [KV cache — general, systems & analysis](../_general/README.md)  

> **TL;DR** — TwinKV is introduced, a training-free, attention-free redundancy signal that detects whether a token's key has a near-duplicate elsewhere in context, challenging the premise behind dominant eviction methods.
...
| Models used | Llama-3.2-1B, Qwen3-4B |
| Impact score | 0.0 |
...
```sh
arxiv read 2608.27128            # full paper as Markdown (github.com/1jmdev/arxiv)
arxiv section 2608.27128 "method"
arxiv bibtex 2608.27128
```
