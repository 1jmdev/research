...
**arXiv:** [2607.15498](https://arxiv.org/abs/2607.15498) · [PDF](https://arxiv.org/pdf/2607.15498) · [HTML](https://arxiv.org/html/2607.15498) · **First submitted:** 2026-07-16  
**Category:** [KV cache eviction / token selection / sparse retrieval](README.md) — **rank #217 of 240** by impact score  
...
> **TL;DR** — VarRate is presented, a training-free KV codec that assigns each token a variable low-rank budget by its query salience, keeping every token at a nonzero rank, and is the strongest matched-memory compressor.
...
| arXiv comments | 20 pages, 8 figures, 24 tables. Includes appendix with additional experiments and analyses |
...
```sh
arxiv read 2607.15498            # full paper as Markdown (github.com/1jmdev/arxiv)
arxiv section 2607.15498 "method"
arxiv bibtex 2607.15498
```
