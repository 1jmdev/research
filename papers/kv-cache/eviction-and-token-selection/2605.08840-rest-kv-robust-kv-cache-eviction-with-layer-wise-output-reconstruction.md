...
**arXiv:** [2605.08840](https://arxiv.org/abs/2605.08840) · [PDF](https://arxiv.org/pdf/2605.08840) · [HTML](https://arxiv.org/html/2605.08840) · **First submitted:** 2026-05-09  
**Category:** [KV cache eviction / token selection / sparse retrieval](README.md) — **rank #35 of 240** by impact score  
**Also relevant to:** [KV cache — general, systems & analysis](../_general/README.md)  

> **TL;DR** — ReST-KV is a robust KV eviction method that combines layer-wise output Reconstruction and Spatial-Temporal smoothing to provide a more comprehensive perspective for the KV cache eviction task and significantly advances performance on long-context benchmarks.
...
| arXiv comments | Accepted at ICLR 2026. Project Page: https://github.com/an-yongqi/rest-kv |
| Citations (Semantic Scholar, 2026-09-25) | 9 (1 influential) |
| Hugging Face upvotes | 0 |
| Code | https://github.com/an-yongqi/rest-kv |
| Impact score | 4.88 |

## Key results (claimed in abstract)

- It surpasses state-of-the-art baselines by 2.58% on LongBench and 15.2% on RULER.
- Additionally, ReST-KV consistently outperforms existing methods on Needle-in-a-Haystack and InfiniteBench, all while achieving a remarkable 10.61$\times$ reduction in decoding latency at 128k context length.
...
```sh
arxiv read 2605.08840            # full paper as Markdown (github.com/1jmdev/arxiv)
arxiv section 2605.08840 "method"
arxiv bibtex 2605.08840
```
